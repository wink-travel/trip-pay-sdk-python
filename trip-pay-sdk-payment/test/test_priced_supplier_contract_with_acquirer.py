...
class TestPricedSupplierContractWithAcquirer(unittest.TestCase):
    """PricedSupplierContractWithAcquirer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PricedSupplierContractWithAcquirer:
        """Test PricedSupplierContractWithAcquirer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PricedSupplierContractWithAcquirer`
        """
        model = PricedSupplierContractWithAcquirer()
        if include_optional:
            return PricedSupplierContractWithAcquirer(
                ...
                total_price = trip_pay_payment.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                total_display_price = trip_pay_payment.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                total_supplier_price = trip_pay_payment.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                total_internal_price = trip_pay_payment.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                total_capture_price = trip_pay_payment.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', )
            )
        else:
    ...
    def testPricedSupplierContractWithAcquirer(self):
        """Test PricedSupplierContractWithAcquirer"""
