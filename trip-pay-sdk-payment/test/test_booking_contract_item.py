...
class TestBookingContractItem(unittest.TestCase):
    """BookingContractItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingContractItem:
        """Test BookingContractItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingContractItem`
        """
        model = BookingContractItem()
        if include_optional:
            return BookingContractItem(
    ...
    def testBookingContractItem(self):
        """Test BookingContractItem"""
