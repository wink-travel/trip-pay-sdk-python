...
class TestNotificationView(unittest.TestCase):
    """NotificationView unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationView:
        """Test NotificationView
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationView`
        """
        ...
        if include_optional:
            return NotificationView(
                ...
                version = 12,
                notification = trip_pay_payment.models.notification.Notification(
                    identifier = '', 
                    owner_identifier = '', 
                    priority = 'HIGH', 
                    type = 'ALERT', 
