...
class TestGeoNameLightweightPayment(unittest.TestCase):
    """GeoNameLightweightPayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoNameLightweightPayment:
        """Test GeoNameLightweightPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoNameLightweightPayment`
        """
        model = GeoNameLightweightPayment()
        if include_optional:
            return GeoNameLightweightPayment(
                geo_name_id = '5128581',
                type = 'CITY',
                name = 'New York City',
                url_name = 'new-york-city-united-states',
                ascii_name = 'New York City',
                location = trip_pay_payment.models.geo_json_point.GeoJsonPoint(
                    x = 1.337, 
                    y = 1.337, 
                    type = '', 
                    coordinates = [
                ...
                country = trip_pay_payment.models.country_lightweight.CountryLightweight(
                    iso = 'US', 
                    iso3 = 'USA', 
                    iso_numeric = 840, 
                    fips = 'US', 
                ...
                sub_country = trip_pay_payment.models.sub_country_lightweight.SubCountryLightweight(
                    code = 'US.NY', 
                    country_code = 'US', 
                    sub_country_code = 'NY', 
                    name = 'New York', 
                    ascii_name = 'New York', 
                    geo_name_id = '5128638', ),
                sub_sub_country = trip_pay_payment.models.sub_sub_country_lightweight.SubSubCountryLightweight(
                    code = '', 
                    country_code = '', 
                    sub_country_code = '', 
    ...
    def testGeoNameLightweightPayment(self):
        """Test GeoNameLightweightPayment"""
