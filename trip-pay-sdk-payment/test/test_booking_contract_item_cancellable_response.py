...
class TestBookingContractItemCancellableResponse(unittest.TestCase):
    """BookingContractItemCancellableResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingContractItemCancellableResponse:
        """Test BookingContractItemCancellableResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingContractItemCancellableResponse`
        """
        model = BookingContractItemCancellableResponse()
        if include_optional:
            return BookingContractItemCancellableResponse(
                ...
                type = 'LODGING',
                source_price = trip_pay_payment.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                supplier_price = trip_pay_payment.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                display_price = trip_pay_payment.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                internal_price = trip_pay_payment.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                capture_price = trip_pay_payment.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                cancellable_by_traveler = True,
                cancellable_by_supplier = True,
                cancellable_with_charges = True,
                source_price_after_refund = trip_pay_payment.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                supplier_price_after_refund = trip_pay_payment.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                display_price_after_refund = trip_pay_payment.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                internal_price_after_refund = trip_pay_payment.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                capture_price_after_refund = trip_pay_payment.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', )
            )
        else:
    ...
    def testBookingContractItemCancellableResponse(self):
        """Test BookingContractItemCancellableResponse"""
