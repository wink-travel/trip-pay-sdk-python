...
class TestCancelBookingContractRequest(unittest.TestCase):
    """CancelBookingContractRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelBookingContractRequest:
        """Test CancelBookingContractRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelBookingContractRequest`
        """
        model = CancelBookingContractRequest()
        if include_optional:
            return CancelBookingContractRequest(
                canceller_type = 'SUPPLIER',
                type = 'NO_SHOW',
                reason = ''
            )
        else:
    ...
    def testCancelBookingContractRequest(self):
        """Test CancelBookingContractRequest"""
