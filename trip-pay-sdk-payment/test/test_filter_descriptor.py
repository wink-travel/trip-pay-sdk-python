...
class TestFilterDescriptor(unittest.TestCase):
    """FilterDescriptor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterDescriptor:
        """Test FilterDescriptor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterDescriptor`
        """
        model = FilterDescriptor()
        if include_optional:
