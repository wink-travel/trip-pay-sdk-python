...
class TestUniqueRequestAuthenticatedEntity(unittest.TestCase):
    """UniqueRequestAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniqueRequestAuthenticatedEntity:
        """Test UniqueRequestAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniqueRequestAuthenticatedEntity`
        """
        model = UniqueRequestAuthenticatedEntity()
        if include_optional:
            return UniqueRequestAuthenticatedEntity(
                name = 'My unique name',
                identifier = ''
            )
        else:
    ...
    def testUniqueRequestAuthenticatedEntity(self):
        """Test UniqueRequestAuthenticatedEntity"""
