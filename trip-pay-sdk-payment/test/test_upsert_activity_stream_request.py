...
class TestUpsertActivityStreamRequest(unittest.TestCase):
    """UpsertActivityStreamRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertActivityStreamRequest:
        """Test UpsertActivityStreamRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertActivityStreamRequest`
        """
        model = UpsertActivityStreamRequest()
        if include_optional:
            return UpsertActivityStreamRequest(
                acl = 'EVERYONE',
                entity_identifier = '',
                event_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                emotion = 'fire',
                comment = 'I am all fired up!',
                i18n_key = 'ACTIVITY.UPLOADED',
                attachment_id = 'test.pdf',
                user = trip_pay_payment.models.activity_stream_user.ActivityStreamUser(
                    user_identifier = '', 
                    name = 'Jane Doe', 
                    profile_picture_url = '', )
            )
    ...
    def testUpsertActivityStreamRequest(self):
        """Test UpsertActivityStreamRequest"""
