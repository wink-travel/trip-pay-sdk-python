...
class TestQuoteLightweight(unittest.TestCase):
    """QuoteLightweight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteLightweight:
        """Test QuoteLightweight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteLightweight`
        """
        model = QuoteLightweight()
        if include_optional:
            return QuoteLightweight(
                source = '0',
                target = '0',
                exchange_rate = 1.337,
                timestamp = 56
