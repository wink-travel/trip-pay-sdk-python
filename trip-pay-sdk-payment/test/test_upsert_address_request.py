...
class TestUpsertAddressRequest(unittest.TestCase):
    """UpsertAddressRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertAddressRequest:
        """Test UpsertAddressRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertAddressRequest`
        """
        model = UpsertAddressRequest()
        if include_optional:
    ...
    def testUpsertAddressRequest(self):
        """Test UpsertAddressRequest"""
