...
class TestSimpleMultimediaAuthenticatedEntity(unittest.TestCase):
    """SimpleMultimediaAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleMultimediaAuthenticatedEntity:
        """Test SimpleMultimediaAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleMultimediaAuthenticatedEntity`
        """
        model = SimpleMultimediaAuthenticatedEntity()
        if include_optional:
            return SimpleMultimediaAuthenticatedEntity(
    ...
    def testSimpleMultimediaAuthenticatedEntity(self):
        """Test SimpleMultimediaAuthenticatedEntity"""
