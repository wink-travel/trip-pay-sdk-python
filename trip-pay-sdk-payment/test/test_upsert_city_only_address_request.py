...
class TestUpsertCityOnlyAddressRequest(unittest.TestCase):
    """UpsertCityOnlyAddressRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertCityOnlyAddressRequest:
        """Test UpsertCityOnlyAddressRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertCityOnlyAddressRequest`
        """
        model = UpsertCityOnlyAddressRequest()
        if include_optional:
            return UpsertCityOnlyAddressRequest(
    ...
    def testUpsertCityOnlyAddressRequest(self):
        """Test UpsertCityOnlyAddressRequest"""
