...
class TestUpsertWebhookManagingEntityRequest(unittest.TestCase):
    """UpsertWebhookManagingEntityRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertWebhookManagingEntityRequest:
        """Test UpsertWebhookManagingEntityRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertWebhookManagingEntityRequest`
        """
        model = UpsertWebhookManagingEntityRequest()
        if include_optional:
            return UpsertWebhookManagingEntityRequest(
                identifier = '123456789',
                name = 'Managing entity prod'
            )
        else:
            return UpsertWebhookManagingEntityRequest(
                identifier = '123456789',
    ...
    def testUpsertWebhookManagingEntityRequest(self):
        """Test UpsertWebhookManagingEntityRequest"""
