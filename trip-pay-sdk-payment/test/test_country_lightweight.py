...
class TestCountryLightweight(unittest.TestCase):
    """CountryLightweight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountryLightweight:
        """Test CountryLightweight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryLightweight`
        """
        model = CountryLightweight()
        if include_optional:
    ...
    def testCountryLightweight(self):
        """Test CountryLightweight"""
