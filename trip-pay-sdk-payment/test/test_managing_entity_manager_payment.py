...
class TestManagingEntityManagerPayment(unittest.TestCase):
    """ManagingEntityManagerPayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagingEntityManagerPayment:
        """Test ManagingEntityManagerPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagingEntityManagerPayment`
        """
        model = ManagingEntityManagerPayment()
        if include_optional:
            return ManagingEntityManagerPayment(
    ...
    def testManagingEntityManagerPayment(self):
        """Test ManagingEntityManagerPayment"""
