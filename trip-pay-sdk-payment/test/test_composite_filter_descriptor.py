...
class TestCompositeFilterDescriptor(unittest.TestCase):
    """CompositeFilterDescriptor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompositeFilterDescriptor:
        """Test CompositeFilterDescriptor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompositeFilterDescriptor`
        """
        model = CompositeFilterDescriptor()
        if include_optional:
            return CompositeFilterDescriptor(
                logic = 'and',
                filters = [
                    trip_pay_payment.models.filter_descriptor.FilterDescriptor(
                        field = 'hotel.name', 
                        operator = 'startsWith', 
                        value = Happy Res, 
                        ignore_case = True, )
    ...
    def testCompositeFilterDescriptor(self):
        """Test CompositeFilterDescriptor"""
