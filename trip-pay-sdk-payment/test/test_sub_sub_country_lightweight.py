...
class TestSubSubCountryLightweight(unittest.TestCase):
    """SubSubCountryLightweight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubSubCountryLightweight:
        """Test SubSubCountryLightweight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubSubCountryLightweight`
        """
        model = SubSubCountryLightweight()
        if include_optional:
            return SubSubCountryLightweight(
                code = '',
                country_code = '',
                sub_country_code = '',
    ...
    def testSubSubCountryLightweight(self):
        """Test SubSubCountryLightweight"""
