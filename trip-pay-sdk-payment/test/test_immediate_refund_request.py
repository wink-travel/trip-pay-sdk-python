...
class TestImmediateRefundRequest(unittest.TestCase):
    """ImmediateRefundRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImmediateRefundRequest:
        """Test ImmediateRefundRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImmediateRefundRequest`
        """
        model = ImmediateRefundRequest()
        if include_optional:
            return ImmediateRefundRequest(
                description = 'Inventory no longer available.'
            )
        else:
            return ImmediateRefundRequest(
                description = 'Inventory no longer available.',
    ...
    def testImmediateRefundRequest(self):
        """Test ImmediateRefundRequest"""
