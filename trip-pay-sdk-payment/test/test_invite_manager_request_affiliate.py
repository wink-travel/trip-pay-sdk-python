...
class TestInviteManagerRequestAffiliate(unittest.TestCase):
    """InviteManagerRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InviteManagerRequestAffiliate:
        """Test InviteManagerRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InviteManagerRequestAffiliate`
        """
        model = InviteManagerRequestAffiliate()
        if include_optional:
            return InviteManagerRequestAffiliate(
                email = '0'
            )
        else:
            return InviteManagerRequestAffiliate(
    ...
    def testInviteManagerRequestAffiliate(self):
        """Test InviteManagerRequestAffiliate"""
