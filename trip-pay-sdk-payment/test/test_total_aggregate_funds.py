...
class TestTotalAggregateFunds(unittest.TestCase):
    """TotalAggregateFunds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TotalAggregateFunds:
        """Test TotalAggregateFunds
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TotalAggregateFunds`
        """
        model = TotalAggregateFunds()
        if include_optional:
    ...
    def testTotalAggregateFunds(self):
        """Test TotalAggregateFunds"""
