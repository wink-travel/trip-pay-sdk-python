...
class TestSortDescriptorPayment(unittest.TestCase):
    """SortDescriptorPayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SortDescriptorPayment:
        """Test SortDescriptorPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortDescriptorPayment`
        """
        model = SortDescriptorPayment()
        if include_optional:
            return SortDescriptorPayment(
                dir = 'asc',
    ...
    def testSortDescriptorPayment(self):
        """Test SortDescriptorPayment"""
