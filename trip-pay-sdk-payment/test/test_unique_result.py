...
class TestUniqueResult(unittest.TestCase):
    """UniqueResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniqueResult:
        """Test UniqueResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniqueResult`
        """
        model = UniqueResult()
        if include_optional:
            return UniqueResult(
