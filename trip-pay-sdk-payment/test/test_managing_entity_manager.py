...
class TestManagingEntityManager(unittest.TestCase):
    """ManagingEntityManager unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagingEntityManager:
        """Test ManagingEntityManager
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagingEntityManager`
        """
        model = ManagingEntityManager()
        if include_optional:
            return ManagingEntityManager(
    ...
    def testManagingEntityManager(self):
        """Test ManagingEntityManager"""
