...
class TestManagingEntityPayment(unittest.TestCase):
    """ManagingEntityPayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagingEntityPayment:
        """Test ManagingEntityPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagingEntityPayment`
        """
        model = ManagingEntityPayment()
        if include_optional:
            return ManagingEntityPayment(
                id = 'doc-1',
    ...
    def testManagingEntityPayment(self):
        """Test ManagingEntityPayment"""
