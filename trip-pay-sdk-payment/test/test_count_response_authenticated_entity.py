...
class TestCountResponseAuthenticatedEntity(unittest.TestCase):
    """CountResponseAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountResponseAuthenticatedEntity:
        """Test CountResponseAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountResponseAuthenticatedEntity`
        """
        model = CountResponseAuthenticatedEntity()
        if include_optional:
            return CountResponseAuthenticatedEntity(
                success = True,
                count = 1543
            )
        else:
    ...
    def testCountResponseAuthenticatedEntity(self):
        """Test CountResponseAuthenticatedEntity"""
