...
class TestUpsertApplicationRequest(unittest.TestCase):
    """UpsertApplicationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertApplicationRequest:
        """Test UpsertApplicationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertApplicationRequest`
        """
        model = UpsertApplicationRequest()
        if include_optional:
            return UpsertApplicationRequest(
                name = 'App 1',
                entity = App 1,
                redirect_uris = [
    ...
    def testUpsertApplicationRequest(self):
        """Test UpsertApplicationRequest"""
