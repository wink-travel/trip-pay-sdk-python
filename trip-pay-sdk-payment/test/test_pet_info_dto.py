...
class TestPetInfoDto(unittest.TestCase):
    """PetInfoDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetInfoDto:
        """Test PetInfoDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetInfoDto`
        """
        model = PetInfoDto()
        if include_optional:
            return PetInfoDto(
