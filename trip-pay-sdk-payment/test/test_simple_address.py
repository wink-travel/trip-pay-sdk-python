...
class TestSimpleAddress(unittest.TestCase):
    """SimpleAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleAddress:
        """Test SimpleAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleAddress`
        """
        model = SimpleAddress()
        if include_optional:
