...
class TestBeneficiaryAggregateData(unittest.TestCase):
    """BeneficiaryAggregateData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeneficiaryAggregateData:
        """Test BeneficiaryAggregateData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeneficiaryAggregateData`
        """
        model = BeneficiaryAggregateData()
        if include_optional:
            return BeneficiaryAggregateData(
                account_identifier = '',
                ...
                supplier_amount = 40.1,
                internal_amount = 40.1
            )
        else:
            return BeneficiaryAggregateData(
                account_identifier = '',
    ...
    def testBeneficiaryAggregateData(self):
        """Test BeneficiaryAggregateData"""
