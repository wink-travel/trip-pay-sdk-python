...
class TestAggregateBookingContractCaptureCurrenciesByAccountResponse(unittest.TestCase):
    """AggregateBookingContractCaptureCurrenciesByAccountResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregateBookingContractCaptureCurrenciesByAccountResponse:
        """Test AggregateBookingContractCaptureCurrenciesByAccountResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateBookingContractCaptureCurrenciesByAccountResponse`
        """
        model = AggregateBookingContractCaptureCurrenciesByAccountResponse()
        if include_optional:
            return AggregateBookingContractCaptureCurrenciesByAccountResponse(
                account_identifier = '',
                list = [
                    trip_pay_payment.models.available_funds.AvailableFunds(
                        supplier_currency = '', 
                        capture_currency = '', 
                        supplier_amount = 1.337, 
    ...
    def testAggregateBookingContractCaptureCurrenciesByAccountResponse(self):
        """Test AggregateBookingContractCaptureCurrenciesByAccountResponse"""
