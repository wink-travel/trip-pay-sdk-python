...
class TestCreateIssuingCardEphemeralKeyRequest(unittest.TestCase):
    """CreateIssuingCardEphemeralKeyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateIssuingCardEphemeralKeyRequest:
        """Test CreateIssuingCardEphemeralKeyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateIssuingCardEphemeralKeyRequest`
        """
        model = CreateIssuingCardEphemeralKeyRequest()
        if include_optional:
            return CreateIssuingCardEphemeralKeyRequest(
                vendor_identifier = 'stripe-slovakia',
                issuing_card = 'card-1',
                nonce = 'nonce-1'
            )
        else:
    ...
    def testCreateIssuingCardEphemeralKeyRequest(self):
        """Test CreateIssuingCardEphemeralKeyRequest"""
