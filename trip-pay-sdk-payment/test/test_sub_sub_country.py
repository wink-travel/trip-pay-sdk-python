...
class TestSubSubCountry(unittest.TestCase):
    """SubSubCountry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubSubCountry:
        """Test SubSubCountry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubSubCountry`
        """
        model = SubSubCountry()
        if include_optional:
