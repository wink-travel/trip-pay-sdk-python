...
class TestSimpleMultimedia(unittest.TestCase):
    """SimpleMultimedia unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleMultimedia:
        """Test SimpleMultimedia
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleMultimedia`
        """
        model = SimpleMultimedia()
        if include_optional:
            return SimpleMultimedia(
