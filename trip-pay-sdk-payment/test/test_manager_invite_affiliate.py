...
class TestManagerInviteAffiliate(unittest.TestCase):
    """ManagerInviteAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagerInviteAffiliate:
        """Test ManagerInviteAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagerInviteAffiliate`
        """
        model = ManagerInviteAffiliate()
        if include_optional:
            return ManagerInviteAffiliate(
                id = '0',
                name = '0',
                image_identifier = ''
            )
    ...
    def testManagerInviteAffiliate(self):
        """Test ManagerInviteAffiliate"""
