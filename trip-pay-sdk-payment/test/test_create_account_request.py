    ...
    def make_instance(self, include_optional) -> CreateAccountRequest:
        ...
        if include_optional:
            return CreateAccountRequest(
                external_identifier = 'external-record-1',
                type = 'MERCHANT',
                owner_type = 'COMPANY',
                name = 'My Company',
                ...
                currency_code = 'GBP',
                address = trip_pay_payment.models.upsert_city_only_address_request.UpsertCityOnlyAddressRequest(
                ...
                bank_accounts = [
                    trip_pay_payment.models.upsert_bank_account_request.UpsertBankAccountRequest(
                        country_code = 'US', 
                        currency_code = 'USD', 
