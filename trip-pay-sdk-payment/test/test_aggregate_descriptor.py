...
class TestAggregateDescriptor(unittest.TestCase):
    """AggregateDescriptor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregateDescriptor:
        """Test AggregateDescriptor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateDescriptor`
        """
        model = AggregateDescriptor()
        if include_optional:
    ...
    def testAggregateDescriptor(self):
        """Test AggregateDescriptor"""
