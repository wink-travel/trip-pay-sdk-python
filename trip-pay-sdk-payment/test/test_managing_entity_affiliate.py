...
class TestManagingEntityAffiliate(unittest.TestCase):
    """ManagingEntityAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagingEntityAffiliate:
        """Test ManagingEntityAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagingEntityAffiliate`
        """
        model = ManagingEntityAffiliate()
        if include_optional:
            return ManagingEntityAffiliate(
                id = 'doc-1',
    ...
    def testManagingEntityAffiliate(self):
        """Test ManagingEntityAffiliate"""
