...
class TestSortObjectPayment(unittest.TestCase):
    """SortObjectPayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SortObjectPayment:
        """Test SortObjectPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortObjectPayment`
        """
        model = SortObjectPayment()
        if include_optional:
            return SortObjectPayment(
                empty = True,
                sorted = True,
                unsorted = True
            )
    ...
    def testSortObjectPayment(self):
        """Test SortObjectPayment"""
