...
class TestAffiliateDetailsRequest(unittest.TestCase):
    """AffiliateDetailsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AffiliateDetailsRequest:
        """Test AffiliateDetailsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AffiliateDetailsRequest`
        """
        model = AffiliateDetailsRequest()
        if include_optional:
            return AffiliateDetailsRequest(
                type = 'INTERNAL',
                identifier = ''
            )
        else:
    ...
    def testAffiliateDetailsRequest(self):
        """Test AffiliateDetailsRequest"""
