...
class TestBeneficiaryCharge(unittest.TestCase):
    """BeneficiaryCharge unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeneficiaryCharge:
        """Test BeneficiaryCharge
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeneficiaryCharge`
        """
        model = BeneficiaryCharge()
        if include_optional:
            return BeneficiaryCharge(
                type = 'PERCENTAGE',
                percent = 1.337
            )
        else:
    ...
    def testBeneficiaryCharge(self):
        """Test BeneficiaryCharge"""
