...
class TestAggregateBookingContractCancellationState(unittest.TestCase):
    """AggregateBookingContractCancellationState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregateBookingContractCancellationState:
        """Test AggregateBookingContractCancellationState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateBookingContractCancellationState`
        """
        model = AggregateBookingContractCancellationState()
        if include_optional:
            return AggregateBookingContractCancellationState(
                cancelled = True,
                count = 56
            )
        else:
    ...
    def testAggregateBookingContractCancellationState(self):
        """Test AggregateBookingContractCancellationState"""
