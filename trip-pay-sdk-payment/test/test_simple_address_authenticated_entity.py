...
class TestSimpleAddressAuthenticatedEntity(unittest.TestCase):
    """SimpleAddressAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleAddressAuthenticatedEntity:
        """Test SimpleAddressAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleAddressAuthenticatedEntity`
        """
        model = SimpleAddressAuthenticatedEntity()
        if include_optional:
            return SimpleAddressAuthenticatedEntity(
                address1 = '234',
    ...
    def testSimpleAddressAuthenticatedEntity(self):
        """Test SimpleAddressAuthenticatedEntity"""
