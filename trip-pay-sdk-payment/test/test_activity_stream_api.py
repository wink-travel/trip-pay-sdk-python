...
class TestActivityStreamApi(unittest.TestCase):
    """ActivityStreamApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ActivityStreamApi()
    ...
    def test_show_stream(self) -> None:
        """Test case for show_stream
