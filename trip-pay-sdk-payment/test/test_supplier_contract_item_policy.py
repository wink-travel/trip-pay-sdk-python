...
class TestSupplierContractItemPolicy(unittest.TestCase):
    """SupplierContractItemPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupplierContractItemPolicy:
        """Test SupplierContractItemPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupplierContractItemPolicy`
        """
        model = SupplierContractItemPolicy()
        if include_optional:
            return SupplierContractItemPolicy(
                refundable = True,
    ...
    def testSupplierContractItemPolicy(self):
        """Test SupplierContractItemPolicy"""
