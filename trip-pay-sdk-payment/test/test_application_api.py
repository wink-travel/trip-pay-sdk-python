...
class TestApplicationApi(unittest.TestCase):
    ...
    def test_load_application(self) -> None:
        """Test case for load_application

        Show Application
        """
        pass

    def test_revoke_application(self) -> None:
        """Test case for revoke_application

        Revoke Application Credentials
        """
        pass

    def test_show_applications_by_user(self) -> None:
        """Test case for show_applications_by_user
