...
class TestVerifyAccountRequest(unittest.TestCase):
    """VerifyAccountRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyAccountRequest:
        """Test VerifyAccountRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyAccountRequest`
        """
        model = VerifyAccountRequest()
        if include_optional:
            return VerifyAccountRequest(
                ...
                disbursement_type = 'VIRTUAL_CREDIT_CARD'
            )
        else:
            return VerifyAccountRequest(
        )
    ...
    def testVerifyAccountRequest(self):
        """Test VerifyAccountRequest"""
