...
class TestPayableContractSupplier(unittest.TestCase):
    """PayableContractSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayableContractSupplier:
        """Test PayableContractSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayableContractSupplier`
        """
        model = PayableContractSupplier()
        if include_optional:
            return PayableContractSupplier(
                identifier = '',
                supplier_identifier = '',
    ...
    def testPayableContractSupplier(self):
        """Test PayableContractSupplier"""
