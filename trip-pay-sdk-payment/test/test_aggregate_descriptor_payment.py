...
class TestAggregateDescriptorPayment(unittest.TestCase):
    """AggregateDescriptorPayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregateDescriptorPayment:
        """Test AggregateDescriptorPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateDescriptorPayment`
        """
        model = AggregateDescriptorPayment()
        if include_optional:
            return AggregateDescriptorPayment(
                var_field = 'hotel.bookings',
                aggregate = 'count'
            )
        else:
            return AggregateDescriptorPayment(
    ...
    def testAggregateDescriptorPayment(self):
        """Test AggregateDescriptorPayment"""
