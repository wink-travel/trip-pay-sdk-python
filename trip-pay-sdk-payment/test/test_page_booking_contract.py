...
class TestPageBookingContract(unittest.TestCase):
    """PageBookingContract unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageBookingContract:
        """Test PageBookingContract
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageBookingContract`
        """
        model = PageBookingContract()
        if include_optional:
    ...
    def testPageBookingContract(self):
        """Test PageBookingContract"""
