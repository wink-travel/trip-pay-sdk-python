...
class TestManagedByEntityRules(unittest.TestCase):
    """ManagedByEntityRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedByEntityRules:
        """Test ManagedByEntityRules
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedByEntityRules`
        """
        model = ManagedByEntityRules()
        if include_optional:
            return ManagedByEntityRules(
    ...
    def testManagedByEntityRules(self):
        """Test ManagedByEntityRules"""
