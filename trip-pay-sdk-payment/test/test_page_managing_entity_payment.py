...
class TestPageManagingEntityPayment(unittest.TestCase):
    """PageManagingEntityPayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageManagingEntityPayment:
        """Test PageManagingEntityPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageManagingEntityPayment`
        """
        model = PageManagingEntityPayment()
        if include_optional:
            return PageManagingEntityPayment(
                total_elements = 56,
                total_pages = 56,
                size = 56,
                content = [
                    trip_pay_payment.models.managing_entity_payment.ManagingEntity_Payment(
                        id = 'doc-1', 
                ...
                sort = trip_pay_payment.models.sort_object_payment.SortObject_Payment(
                    empty = True, 
                    sorted = True, 
                    unsorted = True, ),
                pageable = trip_pay_payment.models.pageable_object_payment.PageableObject_Payment(
                    offset = 56, 
                    paged = True, 
                    page_size = 56, 
                    sort = trip_pay_payment.models.sort_object_payment.SortObject_Payment(
    ...
    def testPageManagingEntityPayment(self):
        """Test PageManagingEntityPayment"""
