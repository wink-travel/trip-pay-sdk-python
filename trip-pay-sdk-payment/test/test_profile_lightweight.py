...
class TestProfileLightweight(unittest.TestCase):
    """ProfileLightweight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileLightweight:
        """Test ProfileLightweight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileLightweight`
        """
        model = ProfileLightweight()
        if include_optional:
    ...
    def testProfileLightweight(self):
        """Test ProfileLightweight"""
