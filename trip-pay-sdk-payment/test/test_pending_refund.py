...
class TestPendingRefund(unittest.TestCase):
    """PendingRefund unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PendingRefund:
        """Test PendingRefund
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PendingRefund`
        """
        model = PendingRefund()
        if include_optional:
