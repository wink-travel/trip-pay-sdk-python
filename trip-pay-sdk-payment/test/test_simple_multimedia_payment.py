...
class TestSimpleMultimediaPayment(unittest.TestCase):
    """SimpleMultimediaPayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleMultimediaPayment:
        """Test SimpleMultimediaPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleMultimediaPayment`
        """
        model = SimpleMultimediaPayment()
        if include_optional:
            return SimpleMultimediaPayment(
    ...
    def testSimpleMultimediaPayment(self):
        """Test SimpleMultimediaPayment"""
