...
class TestUpdateAccountRepresentativeRequestAuthenticatedEntity(unittest.TestCase):
    """UpdateAccountRepresentativeRequestAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAccountRepresentativeRequestAuthenticatedEntity:
        """Test UpdateAccountRepresentativeRequestAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAccountRepresentativeRequestAuthenticatedEntity`
        """
        model = UpdateAccountRepresentativeRequestAuthenticatedEntity()
        if include_optional:
            return UpdateAccountRepresentativeRequestAuthenticatedEntity(
                account_email = 'me@hotel-x.com',
                account_phone_number = '212'
            )
        else:
            return UpdateAccountRepresentativeRequestAuthenticatedEntity(
                account_email = 'me@hotel-x.com',
    ...
    def testUpdateAccountRepresentativeRequestAuthenticatedEntity(self):
        """Test UpdateAccountRepresentativeRequestAuthenticatedEntity"""
