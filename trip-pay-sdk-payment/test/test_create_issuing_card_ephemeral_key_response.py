...
class TestCreateIssuingCardEphemeralKeyResponse(unittest.TestCase):
    """CreateIssuingCardEphemeralKeyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateIssuingCardEphemeralKeyResponse:
        """Test CreateIssuingCardEphemeralKeyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateIssuingCardEphemeralKeyResponse`
        """
        model = CreateIssuingCardEphemeralKeyResponse()
        if include_optional:
            return CreateIssuingCardEphemeralKeyResponse(
                secret = 'stripe-slovakia'
            )
        else:
            return CreateIssuingCardEphemeralKeyResponse(
                secret = 'stripe-slovakia',
    ...
    def testCreateIssuingCardEphemeralKeyResponse(self):
        """Test CreateIssuingCardEphemeralKeyResponse"""
