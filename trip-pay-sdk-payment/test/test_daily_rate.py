...
class TestDailyRate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DailyRate:
        """Test DailyRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DailyRate`
        """
        model = DailyRate()
        if include_optional:
            return DailyRate(
                var_date = 'Mon Aug 24 03:00:00 EEST 2020',
