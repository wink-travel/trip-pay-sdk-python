...
class TestSimpleDescription(unittest.TestCase):
    """SimpleDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleDescription:
        """Test SimpleDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleDescription`
        """
        model = SimpleDescription()
        if include_optional:
    ...
    def testSimpleDescription(self):
        """Test SimpleDescription"""
