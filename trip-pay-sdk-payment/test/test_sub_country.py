...
class TestSubCountry(unittest.TestCase):
    """SubCountry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubCountry:
        """Test SubCountry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubCountry`
        """
        model = SubCountry()
        if include_optional:
            return SubCountry(
