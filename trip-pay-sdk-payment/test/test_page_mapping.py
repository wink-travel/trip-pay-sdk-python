...
class TestPageMapping(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PageMapping:
        """Test PageMapping
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageMapping`
        """
        model = PageMapping()
        if include_optional:
            return PageMapping(
                ...
                size = 56,
                content = [
                    trip_pay_payment.models.mapping.Mapping(
                        id = 'doc-1', 
