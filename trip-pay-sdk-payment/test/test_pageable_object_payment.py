...
class TestPageableObjectPayment(unittest.TestCase):
    """PageableObjectPayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageableObjectPayment:
        """Test PageableObjectPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageableObjectPayment`
        """
        model = PageableObjectPayment()
        if include_optional:
            return PageableObjectPayment(
                offset = 56,
                paged = True,
                page_size = 56,
    ...
    def testPageableObjectPayment(self):
        """Test PageableObjectPayment"""
