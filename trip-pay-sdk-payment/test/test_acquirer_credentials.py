...
class TestAcquirerCredentials(unittest.TestCase):
    """AcquirerCredentials unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AcquirerCredentials:
        """Test AcquirerCredentials
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AcquirerCredentials`
        """
        model = AcquirerCredentials()
        if include_optional:
            return AcquirerCredentials(
                type = 'TOKEN',
                key1 = 'token-1',
                key2 = 'token-2'
            )
    ...
    def testAcquirerCredentials(self):
        """Test AcquirerCredentials"""
