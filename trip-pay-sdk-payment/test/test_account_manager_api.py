...
class TestAccountManagerApi(unittest.TestCase):
    """AccountManagerApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AccountManagerApi()

    def tearDown(self) -> None:
        pass

    def test_accept_manager_invite(self) -> None:
        """Test case for accept_manager_invite

        Accept Invite
        """
        pass

    def test_invite_manager(self) -> None:
        """Test case for invite_manager
    ...
    def test_reject_invite(self) -> None:
        """Test case for reject_invite

        Reject Invite
        """
        pass

    def test_remove_company_user(self) -> None:
        """Test case for remove_company_user

        Remove Manager
        """
        pass

    def test_remove_manager_agency(self) -> None:
        """Test case for remove_manager_agency

        Remove Managing Agency
        """
        pass

    def test_show_manager_invite_list(self) -> None:
        """Test case for show_manager_invite_list

        Show Invites
        """
        pass

    def test_update_manager_agency(self) -> None:
        """Test case for update_manager_agency
