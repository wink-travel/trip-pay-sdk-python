...
class TestMediaAuthorAttribution(unittest.TestCase):
    """MediaAuthorAttribution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MediaAuthorAttribution:
        """Test MediaAuthorAttribution
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MediaAuthorAttribution`
        """
        model = MediaAuthorAttribution()
        if include_optional:
            return MediaAuthorAttribution(
    ...
    def testMediaAuthorAttribution(self):
        """Test MediaAuthorAttribution"""
