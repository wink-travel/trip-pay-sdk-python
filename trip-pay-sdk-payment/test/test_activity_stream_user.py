...
class TestActivityStreamUser(unittest.TestCase):
    """ActivityStreamUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityStreamUser:
        """Test ActivityStreamUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityStreamUser`
        """
        model = ActivityStreamUser()
        if include_optional:
            return ActivityStreamUser(
                user_identifier = '',
                name = 'Jane Doe',
                profile_picture_url = ''
            )
    ...
    def testActivityStreamUser(self):
        """Test ActivityStreamUser"""
