...
class TestUpdateManagingEntityInformationRequestAuthenticatedEntity(unittest.TestCase):
    """UpdateManagingEntityInformationRequestAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateManagingEntityInformationRequestAuthenticatedEntity:
        """Test UpdateManagingEntityInformationRequestAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateManagingEntityInformationRequestAuthenticatedEntity`
        """
        model = UpdateManagingEntityInformationRequestAuthenticatedEntity()
        if include_optional:
            return UpdateManagingEntityInformationRequestAuthenticatedEntity(
                name = 'Affiliate Account 1',
    ...
    def testUpdateManagingEntityInformationRequestAuthenticatedEntity(self):
        """Test UpdateManagingEntityInformationRequestAuthenticatedEntity"""
