...
class TestManagingEntity(unittest.TestCase):
    """ManagingEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagingEntity:
        """Test ManagingEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagingEntity`
        """
        model = ManagingEntity()
        if include_optional:
