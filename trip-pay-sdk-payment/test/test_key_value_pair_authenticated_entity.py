...
class TestKeyValuePairAuthenticatedEntity(unittest.TestCase):
    """KeyValuePairAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeyValuePairAuthenticatedEntity:
        """Test KeyValuePairAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeyValuePairAuthenticatedEntity`
        """
        model = KeyValuePairAuthenticatedEntity()
        if include_optional:
            return KeyValuePairAuthenticatedEntity(
                value = 'id-1',
    ...
    def testKeyValuePairAuthenticatedEntity(self):
        """Test KeyValuePairAuthenticatedEntity"""
