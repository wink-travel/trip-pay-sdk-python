...
class TestNotificationLightweightApi(unittest.TestCase):
    """NotificationLightweightApi unit test stubs"""

    def setUp(self) -> None:
        self.api = NotificationLightweightApi()
    ...
    def test_show_notification(self) -> None:
        """Test case for show_notification

        Show NotificationLightweight
        """
        pass

    def test_show_notifications(self) -> None:
        """Test case for show_notifications

        Show Notifications
        """
        pass

    def test_show_unread_message_count(self) -> None:
        """Test case for show_unread_message_count
