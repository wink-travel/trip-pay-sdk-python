...
class TestSubCountryLightweight(unittest.TestCase):
    """SubCountryLightweight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubCountryLightweight:
        """Test SubCountryLightweight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubCountryLightweight`
        """
        model = SubCountryLightweight()
        if include_optional:
            return SubCountryLightweight(
                code = 'US.NY',
                country_code = 'US',
                sub_country_code = 'NY',
                name = 'New York',
    ...
    def testSubCountryLightweight(self):
        """Test SubCountryLightweight"""
