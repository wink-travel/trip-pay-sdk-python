...
class TestRevokeClientIdResponse(unittest.TestCase):
    """RevokeClientIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RevokeClientIdResponse:
        """Test RevokeClientIdResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RevokeClientIdResponse`
        """
        model = RevokeClientIdResponse()
        if include_optional:
    ...
    def testRevokeClientIdResponse(self):
        """Test RevokeClientIdResponse"""
