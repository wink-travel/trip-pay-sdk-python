...
class TestUpsertWebhookRequest(unittest.TestCase):
    """UpsertWebhookRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertWebhookRequest:
        """Test UpsertWebhookRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertWebhookRequest`
        """
        model = UpsertWebhookRequest()
        if include_optional:
            return UpsertWebhookRequest(
                name = 'Webhook prod',
                entity = App 1,
                enabled = True,
                event_url = 'https://www.webhook.com/event',
                event_list = [
                    'account.created'
                    ]
            )
    ...
    def testUpsertWebhookRequest(self):
        """Test UpsertWebhookRequest"""
