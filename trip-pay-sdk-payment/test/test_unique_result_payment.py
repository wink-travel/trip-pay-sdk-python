...
class TestUniqueResultPayment(unittest.TestCase):
    """UniqueResultPayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniqueResultPayment:
        """Test UniqueResultPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniqueResultPayment`
        """
        model = UniqueResultPayment()
        if include_optional:
            return UniqueResultPayment(
                unique = True
            )
        else:
            return UniqueResultPayment(
    ...
    def testUniqueResultPayment(self):
        """Test UniqueResultPayment"""
