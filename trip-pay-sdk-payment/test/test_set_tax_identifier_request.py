...
class TestSetTaxIdentifierRequest(unittest.TestCase):
    """SetTaxIdentifierRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetTaxIdentifierRequest:
        """Test SetTaxIdentifierRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetTaxIdentifierRequest`
        """
        model = SetTaxIdentifierRequest()
        if include_optional:
            return SetTaxIdentifierRequest(
                tax_id = '111-11-1111'
            )
        else:
            return SetTaxIdentifierRequest(
    ...
    def testSetTaxIdentifierRequest(self):
        """Test SetTaxIdentifierRequest"""
