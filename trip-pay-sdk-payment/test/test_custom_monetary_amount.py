...
class TestCustomMonetaryAmount(unittest.TestCase):
    """CustomMonetaryAmount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomMonetaryAmount:
        """Test CustomMonetaryAmount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomMonetaryAmount`
        """
        model = CustomMonetaryAmount()
        if include_optional:
            return CustomMonetaryAmount(
                amount = 1.337,
                currency = ''
            )
        else:
    ...
    def testCustomMonetaryAmount(self):
        """Test CustomMonetaryAmount"""
