...
class TestFilterDescriptorPayment(unittest.TestCase):
    """FilterDescriptorPayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterDescriptorPayment:
        """Test FilterDescriptorPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterDescriptorPayment`
        """
        model = FilterDescriptorPayment()
        if include_optional:
            return FilterDescriptorPayment(
                var_field = 'hotel.name',
                operator = 'startsWith',
                value = None,
                ignore_case = True
            )
    ...
    def testFilterDescriptorPayment(self):
        """Test FilterDescriptorPayment"""
