...
class TestStatePayment(unittest.TestCase):
    """StatePayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatePayment:
        """Test StatePayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatePayment`
        """
        model = StatePayment()
        if include_optional:
            return StatePayment(
                ...
                take = 10,
                sort = [
                    trip_pay_payment.models.sort_descriptor_payment.SortDescriptor_Payment(
                        dir = 'asc', 
                        field = 'hotel.name', )
                    ],
                filter = trip_pay_payment.models.composite_filter_descriptor_payment.CompositeFilterDescriptor_Payment(
                    logic = 'and', 
                    filters = [
                        trip_pay_payment.models.filter_descriptor_payment.FilterDescriptor_Payment(
                            field = 'hotel.name', 
                            operator = 'startsWith', 
                            value = null, 
                            ignore_case = True, )
                ...
                group = [
                    trip_pay_payment.models.group_descriptor_payment.GroupDescriptor_Payment(
                        field = 'createdDate', 
                        dir = 'asc', 
                        aggregates = [
                            trip_pay_payment.models.aggregate_descriptor_payment.AggregateDescriptor_Payment(
