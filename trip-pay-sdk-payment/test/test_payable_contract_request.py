...
class TestPayableContractRequest(unittest.TestCase):
    """PayableContractRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayableContractRequest:
        """Test PayableContractRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayableContractRequest`
        """
        model = PayableContractRequest()
        if include_optional:
            return PayableContractRequest(
    ...
    def testPayableContractRequest(self):
        """Test PayableContractRequest"""
