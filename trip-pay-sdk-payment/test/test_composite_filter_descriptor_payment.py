...
class TestCompositeFilterDescriptorPayment(unittest.TestCase):
    """CompositeFilterDescriptorPayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompositeFilterDescriptorPayment:
        """Test CompositeFilterDescriptorPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompositeFilterDescriptorPayment`
        """
        model = CompositeFilterDescriptorPayment()
        if include_optional:
            return CompositeFilterDescriptorPayment(
                logic = 'and',
                filters = [
    ...
    def testCompositeFilterDescriptorPayment(self):
        """Test CompositeFilterDescriptorPayment"""
