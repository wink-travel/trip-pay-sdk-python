...
class TestSimpleDateTimeItinerary(unittest.TestCase):
    """SimpleDateTimeItinerary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleDateTimeItinerary:
        """Test SimpleDateTimeItinerary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleDateTimeItinerary`
        """
        model = SimpleDateTimeItinerary()
        if include_optional:
            return SimpleDateTimeItinerary(
    ...
    def testSimpleDateTimeItinerary(self):
        """Test SimpleDateTimeItinerary"""
