...
class TestExternalEventApi(unittest.TestCase):
    """ExternalEventApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ExternalEventApi()

    def tearDown(self) -> None:
        pass

    def test_show_external_event(self) -> None:
        """Test case for show_external_event

        Show External Event
        """
        pass

    def test_show_external_event_grid(self) -> None:
        """Test case for show_external_event_grid

        Show External Event Grid
        """
        pass

    def test_show_external_event_list(self) -> None:
        """Test case for show_external_event_list
