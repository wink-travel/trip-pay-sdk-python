...
class TestManagedByEntity(unittest.TestCase):
    """ManagedByEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedByEntity:
        """Test ManagedByEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedByEntity`
        """
        model = ManagedByEntity()
        if include_optional:
            return ManagedByEntity(
                identifier = 'agency-1',
                name = 'Agency X',
