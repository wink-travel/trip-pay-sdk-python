...
class TestUpsertImageRequestAuthenticatedEntity(unittest.TestCase):
    """UpsertImageRequestAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertImageRequestAuthenticatedEntity:
        """Test UpsertImageRequestAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertImageRequestAuthenticatedEntity`
        """
        model = UpsertImageRequestAuthenticatedEntity()
        if include_optional:
            return UpsertImageRequestAuthenticatedEntity(
                image = trip_pay_payment.models.simple_multimedia.SimpleMultimedia(
    ...
    def testUpsertImageRequestAuthenticatedEntity(self):
        """Test UpsertImageRequestAuthenticatedEntity"""
