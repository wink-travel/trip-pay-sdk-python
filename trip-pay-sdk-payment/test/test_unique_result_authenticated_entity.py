...
class TestUniqueResultAuthenticatedEntity(unittest.TestCase):
    """UniqueResultAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniqueResultAuthenticatedEntity:
        """Test UniqueResultAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniqueResultAuthenticatedEntity`
        """
        model = UniqueResultAuthenticatedEntity()
        if include_optional:
            return UniqueResultAuthenticatedEntity(
                unique = True
            )
        else:
            return UniqueResultAuthenticatedEntity(
    ...
    def testUniqueResultAuthenticatedEntity(self):
        """Test UniqueResultAuthenticatedEntity"""
