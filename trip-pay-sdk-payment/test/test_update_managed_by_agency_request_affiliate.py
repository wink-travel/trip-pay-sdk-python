...
class TestUpdateManagedByAgencyRequestAffiliate(unittest.TestCase):
    """UpdateManagedByAgencyRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateManagedByAgencyRequestAffiliate:
        """Test UpdateManagedByAgencyRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateManagedByAgencyRequestAffiliate`
        """
        model = UpdateManagedByAgencyRequestAffiliate()
        if include_optional:
            return UpdateManagedByAgencyRequestAffiliate(
                managing_entity_identifier = '0',
                commission_in_percent = 0.01,
                rules = trip_pay_payment.models.managed_by_entity_rules.ManagedByEntityRules(
    ...
    def testUpdateManagedByAgencyRequestAffiliate(self):
        """Test UpdateManagedByAgencyRequestAffiliate"""
