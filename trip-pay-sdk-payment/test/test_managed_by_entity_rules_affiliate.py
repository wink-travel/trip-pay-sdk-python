...
class TestManagedByEntityRulesAffiliate(unittest.TestCase):
    """ManagedByEntityRulesAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedByEntityRulesAffiliate:
        """Test ManagedByEntityRulesAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedByEntityRulesAffiliate`
        """
        model = ManagedByEntityRulesAffiliate()
        if include_optional:
            return ManagedByEntityRulesAffiliate(
    ...
    def testManagedByEntityRulesAffiliate(self):
        """Test ManagedByEntityRulesAffiliate"""
