...
class TestUpdateMappingRequest(unittest.TestCase):
    """UpdateMappingRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMappingRequest:
        """Test UpdateMappingRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateMappingRequest`
        """
        model = UpdateMappingRequest()
        if include_optional:
    ...
    def testUpdateMappingRequest(self):
        """Test UpdateMappingRequest"""
