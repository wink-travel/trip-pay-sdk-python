...
class TestRawDailyRate(unittest.TestCase):
    """RawDailyRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RawDailyRate:
        """Test RawDailyRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RawDailyRate`
        """
        model = RawDailyRate()
        if include_optional:
            return RawDailyRate(
