...
class TestGuestUser(unittest.TestCase):
    """GuestUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestUser:
        """Test GuestUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestUser`
        """
        model = GuestUser()
        if include_optional:
            return GuestUser(
