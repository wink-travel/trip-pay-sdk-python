...
class TestBookingContractCancellableResponse(unittest.TestCase):
    """BookingContractCancellableResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingContractCancellableResponse:
        """Test BookingContractCancellableResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingContractCancellableResponse`
        """
        model = BookingContractCancellableResponse()
        if include_optional:
            return BookingContractCancellableResponse(
                identifier = '',
                cancellable = True,
                list = [
                    trip_pay_payment.models.booking_contract_item_cancellable_response.BookingContractItemCancellableResponse(
                        ...
                        source_price_after_refund = , 
                        supplier_price_after_refund = , 
                        display_price_after_refund = , 
                        internal_price_after_refund = , 
                        capture_price_after_refund = , )
                    ]
            )
        else:
            return BookingContractCancellableResponse(
    ...
    def testBookingContractCancellableResponse(self):
        """Test BookingContractCancellableResponse"""
