...
class TestChangeManagingEntityNameRequestAuthenticatedEntity(unittest.TestCase):
    """ChangeManagingEntityNameRequestAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChangeManagingEntityNameRequestAuthenticatedEntity:
        """Test ChangeManagingEntityNameRequestAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChangeManagingEntityNameRequestAuthenticatedEntity`
        """
        model = ChangeManagingEntityNameRequestAuthenticatedEntity()
        if include_optional:
            return ChangeManagingEntityNameRequestAuthenticatedEntity(
                trade_name = 'Happy Resorts',
                legal_name = 'Getaway Resorts'
            )
        else:
            return ChangeManagingEntityNameRequestAuthenticatedEntity(
                trade_name = 'Happy Resorts',
    ...
    def testChangeManagingEntityNameRequestAuthenticatedEntity(self):
        """Test ChangeManagingEntityNameRequestAuthenticatedEntity"""
