...
class TestUpsertBankAccountRequest(unittest.TestCase):
    """UpsertBankAccountRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertBankAccountRequest:
        """Test UpsertBankAccountRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertBankAccountRequest`
        """
        model = UpsertBankAccountRequest()
        if include_optional:
            return UpsertBankAccountRequest(
                country_code = 'US',
                currency_code = 'USD',
                account_holder_name = '12345678',
                swift_code = 'HHKHD',
    ...
    def testUpsertBankAccountRequest(self):
        """Test UpsertBankAccountRequest"""
