...
class TestPayableContractResponse(unittest.TestCase):
    """PayableContractResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayableContractResponse:
        """Test PayableContractResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayableContractResponse`
        """
        model = PayableContractResponse()
        if include_optional:
            return PayableContractResponse(
                id = 'contract-1',
                trace_id = 'trace-1',
                supplier_contract_identifier = '',
                supplier_identifier = '',
    ...
    def testPayableContractResponse(self):
        """Test PayableContractResponse"""
