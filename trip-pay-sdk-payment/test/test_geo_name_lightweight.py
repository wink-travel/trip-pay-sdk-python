...
class TestGeoNameLightweight(unittest.TestCase):
    """GeoNameLightweight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoNameLightweight:
        """Test GeoNameLightweight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoNameLightweight`
        """
        model = GeoNameLightweight()
        if include_optional:
            return GeoNameLightweight(
                geo_name_id = '5128581',
                type = 'CITY',
                name = 'New York City',
    ...
    def testGeoNameLightweight(self):
        """Test GeoNameLightweight"""
