...
class TestNotificationAuthenticatedEntity(unittest.TestCase):
    """NotificationAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationAuthenticatedEntity:
        """Test NotificationAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationAuthenticatedEntity`
        """
        model = NotificationAuthenticatedEntity()
        if include_optional:
            return NotificationAuthenticatedEntity(
                id = 'doc-1',
    ...
    def testNotificationAuthenticatedEntity(self):
        """Test NotificationAuthenticatedEntity"""
