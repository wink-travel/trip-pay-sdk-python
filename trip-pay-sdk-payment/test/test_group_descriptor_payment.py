...
class TestGroupDescriptorPayment(unittest.TestCase):
    """GroupDescriptorPayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupDescriptorPayment:
        """Test GroupDescriptorPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupDescriptorPayment`
        """
        model = GroupDescriptorPayment()
        if include_optional:
            return GroupDescriptorPayment(
    ...
    def testGroupDescriptorPayment(self):
        """Test GroupDescriptorPayment"""
