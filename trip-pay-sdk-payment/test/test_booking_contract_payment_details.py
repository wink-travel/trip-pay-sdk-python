...
class TestBookingContractPaymentDetails(unittest.TestCase):
    """BookingContractPaymentDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingContractPaymentDetails:
        """Test BookingContractPaymentDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingContractPaymentDetails`
        """
        model = BookingContractPaymentDetails()
        if include_optional:
            return BookingContractPaymentDetails(
    ...
    def testBookingContractPaymentDetails(self):
        """Test BookingContractPaymentDetails"""
