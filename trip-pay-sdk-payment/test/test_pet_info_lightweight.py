...
class TestPetInfoLightweight(unittest.TestCase):
    """PetInfoLightweight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetInfoLightweight:
        """Test PetInfoLightweight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetInfoLightweight`
        """
        model = PetInfoLightweight()
        if include_optional:
            return PetInfoLightweight(
                name = '0',
                type = '0'
            )
        else:
    ...
    def testPetInfoLightweight(self):
        """Test PetInfoLightweight"""
