...
class TestRemoveEntryResponse(unittest.TestCase):
    """RemoveEntryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoveEntryResponse:
        """Test RemoveEntryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveEntryResponse`
        """
        model = RemoveEntryResponse()
        if include_optional:
    ...
    def testRemoveEntryResponse(self):
        """Test RemoveEntryResponse"""
