...
class TestManagingEntityProvisionPayment(unittest.TestCase):
    """ManagingEntityProvisionPayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagingEntityProvisionPayment:
        """Test ManagingEntityProvisionPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagingEntityProvisionPayment`
        """
        model = ManagingEntityProvisionPayment()
        if include_optional:
            return ManagingEntityProvisionPayment(
    ...
    def testManagingEntityProvisionPayment(self):
        """Test ManagingEntityProvisionPayment"""
