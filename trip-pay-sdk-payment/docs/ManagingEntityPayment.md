...
managing_entity_payment_instance = ManagingEntityPayment.from_json(json)
# print the JSON string representation of the object
print(ManagingEntityPayment.to_json())

# convert the object into a dict
managing_entity_payment_dict = managing_entity_payment_instance.to_dict()
# create an instance of ManagingEntityPayment from a dict
managing_entity_payment_from_dict = ManagingEntityPayment.from_dict(managing_entity_payment_dict)
```
