...
**internal_price_quote** | [**QuoteLightweight**](QuoteLightweight.md) | The quote used to create internalAmount. | 
**capture_price_quote** | [**QuoteLightweight**](QuoteLightweight.md) | The quote used to create captureAmount. | 
**item_list** | [**List[BookingContractItem]**](BookingContractItem.md) | Holds one booking line item for a specific supplier. | 
**external_supplier_identifier** | **str** | Contract creator can choose to identify this record with her own identifier | [optional] 
**external_supplier_booking_code** | **str** | External booking code generated by the caller | [optional] 
**payment** | [**BookingContractPaymentDetails**](BookingContractPaymentDetails.md) | Details of the payment. Payment details will be empty if account type is AGENT | 
**cancelled** | **bool** | Whether the booking was cancelled. | 
...
**canceller_user_identifier** | **str** | UserLightweight identifier that cancelled the entity. | [optional] 
...
**total_fees_and_commissions_in_percent** | **float** | Total fees + commissions in percent | [optional] 
**original_fees_in_percent** | **float** | Platform fee in percent | [optional] 
...
**net_total_customers_source_amount** | [**CustomMonetaryAmount**](CustomMonetaryAmount.md) | Returns the total amount in source currency minus TripPay fee. | [optional] 
**net_total_customers_capture_amount** | [**CustomMonetaryAmount**](CustomMonetaryAmount.md) | Returns the total amount in capture currency minus TripPay fee. | [optional] 
**net_total_customers_display_amount** | [**CustomMonetaryAmount**](CustomMonetaryAmount.md) | Returns the total amount in display currency minus TripPay fee. | [optional] 
**net_total_customers_supplier_amount** | [**CustomMonetaryAmount**](CustomMonetaryAmount.md) | Returns the total amount in supplier currency minus TripPay fee. | [optional] 
**net_total_customers_internal_amount** | [**CustomMonetaryAmount**](CustomMonetaryAmount.md) | Returns the total amount in internal currency minus TripPay fee. | [optional] 
...
**net_total_affiliate_agency_fees_source_amount** | [**CustomMonetaryAmount**](CustomMonetaryAmount.md) | Returns the net total amount in source currency owed affiliate agency. | [optional] 
**net_total_affiliate_agency_fees_capture_amount** | [**CustomMonetaryAmount**](CustomMonetaryAmount.md) | Returns the net total amount in capture currency owed affiliate agency. | [optional] 
**net_total_affiliate_agency_fees_display_amount** | [**CustomMonetaryAmount**](CustomMonetaryAmount.md) | Returns the net total amount in display currency owed affiliate agency. | [optional] 
**net_total_affiliate_agency_fees_supplier_amount** | [**CustomMonetaryAmount**](CustomMonetaryAmount.md) | Returns the net total amount in supplier currency owed affiliate agency. | [optional] 
**net_total_affiliate_agency_fees_internal_amount** | [**CustomMonetaryAmount**](CustomMonetaryAmount.md) | Returns the net total amount in internal currency owed affiliate agency. | [optional] 
**net_total_supplier_agency_fees_source_amount** | [**CustomMonetaryAmount**](CustomMonetaryAmount.md) | Returns the net total amount in source currency owed supplier agency. | [optional] 
**net_total_supplier_agency_fees_capture_amount** | [**CustomMonetaryAmount**](CustomMonetaryAmount.md) | Returns the net total amount in capture currency owed supplier agency. | [optional] 
**net_total_supplier_agency_fees_display_amount** | [**CustomMonetaryAmount**](CustomMonetaryAmount.md) | Returns the net total amount in display currency owed supplier agency. | [optional] 
**net_total_supplier_agency_fees_supplier_amount** | [**CustomMonetaryAmount**](CustomMonetaryAmount.md) | Returns the net total amount in supplier currency owed supplier agency. | [optional] 
**net_total_supplier_agency_fees_internal_amount** | [**CustomMonetaryAmount**](CustomMonetaryAmount.md) | Returns the net total amount in internal currency owed supplier agency. | [optional] 
...
booking_contract_instance = BookingContract.from_json(json)
# print the JSON string representation of the object
print(BookingContract.to_json())

# convert the object into a dict
booking_contract_dict = booking_contract_instance.to_dict()
# create an instance of BookingContract from a dict
booking_contract_from_dict = BookingContract.from_dict(booking_contract_dict)
```
