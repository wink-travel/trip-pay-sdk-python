...
class PetInfoLightweight(BaseModel):
    """
    PetInfoLightweight
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Pet name")
    type: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Pet type")
