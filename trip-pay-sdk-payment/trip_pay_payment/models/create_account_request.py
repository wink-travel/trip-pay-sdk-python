...
class CreateAccountRequest(BaseModel):
    ...
    address: Optional[UpsertCityOnlyAddressRequest] = Field(default=None, description="Account address. Usually the business address")
    acquirers: Optional[List[Any]] = None
    bank_accounts: Optional[List[Any]] = Field(default=None, alias="bankAccounts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bankAccounts": obj.get("bankAccounts"),
