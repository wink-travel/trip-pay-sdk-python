...
class AggregateBookingContractCaptureCurrenciesByAccountResponse(BaseModel):
    """
    AggregateBookingContractCaptureCurrenciesByAccountResponse
    """ # noqa: E501
    account_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Account identifier with these capture currencies", alias="accountIdentifier")
    list: List[AvailableFunds] = Field(description="List of capture currencies")
    __properties: ClassVar[List[str]] = ["accountIdentifier", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": [AvailableFunds.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
