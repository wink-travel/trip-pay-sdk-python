...
class Mapping(BaseModel):
    ...
    account_owner_identifier: StrictStr = Field(description="The entity that owns this account.", alias="accountOwnerIdentifier")
    local_account_identifier: StrictStr = Field(description="Local account identifier is the account identifier of the remote entity within TripPay", alias="localAccountIdentifier")
    external_identifier: StrictStr = Field(description="External identifier is the identifier of this entity in a remote system", alias="externalIdentifier")
    account_identifier: StrictStr = Field(description="Account identifier is the account doing the mapping", alias="accountIdentifier")
    name: StrictStr = Field(description="Name of the entity being mapped")
