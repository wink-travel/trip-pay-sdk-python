...
class Mapping(BaseModel):
    ...
    account_owner_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The entity that owns this account.", alias="accountOwnerIdentifier")
    local_account_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Local account identifier is the account identifier of the remote entity within TripPay", alias="localAccountIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "accountOwnerIdentifier", "localAccountIdentifier", "externalIdentifier", "accountIdentifier", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "localAccountIdentifier": obj.get("localAccountIdentifier"),
