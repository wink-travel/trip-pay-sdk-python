...
class CountryLightweight(BaseModel):
    """
    Country
    """ # noqa: E501
    iso: Optional[StrictStr] = Field(default=None, description="ISO code")
    iso3: Optional[StrictStr] = Field(default=None, description="3 character ISO code")
    iso_numeric: Optional[StrictInt] = Field(default=None, description="Numeric ISO code", alias="isoNumeric")
    fips: Optional[StrictStr] = Field(default=None, description="FIPS country code")
    name: Optional[StrictStr] = Field(default=None, description="Country name")
    capital: Optional[StrictStr] = Field(default=None, description="Country capital")
    area: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Area in square kilometers")
    population: Optional[StrictInt] = Field(default=None, description="Country population")
    continent: Optional[StrictStr] = Field(default=None, description="Continent code")
    top_level_domain: Optional[StrictStr] = Field(default=None, description="Country TLD", alias="topLevelDomain")
    currency_code: Optional[StrictStr] = Field(default=None, description="Currency code", alias="currencyCode")
    currency_name: Optional[StrictStr] = Field(default=None, description="Currency name", alias="currencyName")
    phone: Optional[StrictStr] = Field(default=None, description="Calling code")
    postal_code_format: Optional[StrictStr] = Field(default=None, description="Postal code format", alias="postalCodeFormat")
    postal_code_reg_ex: Optional[StrictStr] = Field(default=None, description="Postal code regular expression", alias="postalCodeRegEx")
    languages: Optional[List[StrictStr]] = Field(default=None, description="Country languages")
    geo_name_id: Optional[StrictStr] = Field(default=None, description="Country GeoNames identifier", alias="geoNameId")
    neighbors: Optional[List[StrictStr]] = Field(default=None, description="Neighboring countries")
    __properties: ClassVar[List[str]] = ["iso", "iso3", "isoNumeric", "fips", "name", "capital", "area", "population", "continent", "topLevelDomain", "currencyCode", "currencyName", "phone", "postalCodeFormat", "postalCodeRegEx", "languages", "geoNameId", "neighbors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "topLevelDomain": obj.get("topLevelDomain"),
            "currencyCode": obj.get("currencyCode"),
            "currencyName": obj.get("currencyName"),
            "phone": obj.get("phone"),
            "postalCodeFormat": obj.get("postalCodeFormat"),
