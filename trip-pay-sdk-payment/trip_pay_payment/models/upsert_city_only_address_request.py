...
class UpsertCityOnlyAddressRequest(BaseModel):
    """
    ...
    city_geo_name_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="City geo name ID", alias="cityGeoNameId")
    ...
    __properties: ClassVar[List[str]] = ["address1", "address2", "cityGeoNameId", "state", "postalCode", "county", "valid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cityGeoNameId": obj.get("cityGeoNameId"),
            "state": obj.get("state"),
