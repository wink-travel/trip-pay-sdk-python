...
class ProfileUser(BaseModel):
    ...
    phone: Optional[StrictStr] = Field(default=None, description="Telephone")
    profile_picture_url: Optional[StrictStr] = Field(default=None, description="Profile picture URL", alias="profilePictureUrl")
    full_name: Optional[StrictStr] = Field(default=None, description="Full name", alias="fullName")
    __properties: ClassVar[List[str]] = ["firstName", "lastName", "email", "phone", "profilePictureUrl", "fullName"]
