...
class TotalAggregateFunds(BaseModel):
    """
    TotalAggregateFunds
    """ # noqa: E501
    source_currency: Optional[StrictStr] = Field(default=None, alias="sourceCurrency")
    display_currency: Optional[StrictStr] = Field(default=None, alias="displayCurrency")
    supplier_currency: Optional[StrictStr] = Field(default=None, alias="supplierCurrency")
    internal_currency: Optional[StrictStr] = Field(default=None, alias="internalCurrency")
    capture_currency: Optional[StrictStr] = Field(default=None, alias="captureCurrency")
    ...
    supplier_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="supplierAmount")
    internal_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="internalAmount")
    capture_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="captureAmount")
    __properties: ClassVar[List[str]] = ["sourceCurrency", "displayCurrency", "supplierCurrency", "internalCurrency", "captureCurrency", "sourceAmount", "displayAmount", "supplierAmount", "internalAmount", "captureAmount"]
