...
class Acquirer(BaseModel):
    ...
    """ # noqa: E501
    acquirer_id: StrictStr = Field(description="Unique identifier.", alias="acquirerId")
    ...
    __properties: ClassVar[List[str]] = ["acquirerId", "priority", "vendor", "type", "currencyCode", "credentials", "webhookSecret", "publicToken"]
