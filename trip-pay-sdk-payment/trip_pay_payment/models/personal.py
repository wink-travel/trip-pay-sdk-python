...
class Personal(BaseModel):
    ...
    contact_person: Optional[List[Any]] = Field(default=None, alias="contactPerson")
    phys_chall_name: Optional[List[Any]] = Field(default=None, alias="physChallName")
    pet_info: Optional[List[Any]] = Field(default=None, alias="petInfo")
