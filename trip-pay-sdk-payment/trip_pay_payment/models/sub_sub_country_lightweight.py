...
class SubSubCountryLightweight(BaseModel):
    """
    SubSubCountryLightweight
    """ # noqa: E501
    code: Optional[StrictStr] = None
    country_code: Optional[StrictStr] = Field(default=None, alias="countryCode")
    sub_country_code: Optional[StrictStr] = Field(default=None, alias="subCountryCode")
    sub_sub_country_code: Optional[StrictStr] = Field(default=None, alias="subSubCountryCode")
    ...
    __properties: ClassVar[List[str]] = ["code", "countryCode", "subCountryCode", "subSubCountryCode", "name", "asciiName", "geoNameId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subSubCountryCode": obj.get("subSubCountryCode"),
            "name": obj.get("name"),
