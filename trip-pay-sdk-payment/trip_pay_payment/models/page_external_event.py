...
class PageExternalEvent(BaseModel):
    """
    PageExternalEvent
    """ # noqa: E501
    ...
    content: Optional[List[ExternalEvent]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [ExternalEvent.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
