...
class ManagingEntityManagerPayment(BaseModel):
    """
    ...
    profile_picture: Optional[SimpleMultimedia] = Field(default=None, description="Profile picture is available", alias="profilePicture")
    owner: Optional[StrictBool] = Field(default=None, description="Account owner")
    roles: Optional[List[StrictStr]] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["email", "status", "userIdentifier", "firstName", "lastName", "secondaryEmail", "phoneNumber", "profilePicture", "owner", "roles", "name"]
