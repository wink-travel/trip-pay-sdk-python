...
class Webhook(BaseModel):
    ...
    Webhook
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Document UUID")
    ...
    user_identifier: UUID = Field(description="Unique owner record identifier", alias="userIdentifier")
    ...
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Descriptive name of webhook.")
    enabled: StrictBool = Field(description="Whether this webhook is enabled.")
    event_url: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The url to POST event to.", alias="eventUrl")
    event_list: List[Any] = Field(alias="eventList")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "userIdentifier", "ownerIdentifier", "ownerName", "ownerType", "name", "enabled", "eventUrl", "eventList"]
