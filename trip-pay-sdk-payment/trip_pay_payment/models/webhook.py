...
class Webhook(BaseModel):
    ...
    Webhook
    """ # noqa: E501
    id: StrictStr = Field(description="Document UUID")
    ...
    user_identifier: StrictStr = Field(description="Unique owner record identifier", alias="userIdentifier")
    ...
    name: StrictStr = Field(description="Descriptive name of webhook.")
    enabled: StrictBool = Field(description="Whether this webhook is enabled.")
    event_url: StrictStr = Field(description="The url to POST event to.", alias="eventUrl")
