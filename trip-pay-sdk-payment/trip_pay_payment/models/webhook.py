...
class Webhook(BaseModel):
    ...
    event_list: List[StrictStr] = Field(alias="eventList")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "userIdentifier", "ownerIdentifier", "ownerName", "name", "enabled", "eventUrl", "eventList"]
