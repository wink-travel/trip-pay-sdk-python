...
class QuoteLightweight(BaseModel):
    """
    QuoteLightweight
    """ # noqa: E501
    source: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Source")
    target: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Target")
