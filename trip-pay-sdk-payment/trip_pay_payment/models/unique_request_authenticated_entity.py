...
class UniqueRequestAuthenticatedEntity(BaseModel):
    """
    UniqueRequestAuthenticatedEntity
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The name we want to check uniqueness for")
    identifier: Optional[UUID] = Field(default=None, description="An optional accompanying identifier so it doesn't check itself on an update")
