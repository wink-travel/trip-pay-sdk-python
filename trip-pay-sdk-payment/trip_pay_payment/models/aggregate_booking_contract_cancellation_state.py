...
class AggregateBookingContractCancellationState(BaseModel):
    """
    AggregateBookingContractCancellationState
    """ # noqa: E501
    cancelled: StrictBool = Field(description="Whether booking contract was cancelled")
    count: StrictInt = Field(description="Aggregate booking contract of the cancellation state")
    __properties: ClassVar[List[str]] = ["cancelled", "count"]
