...
class AvailableFunds(BaseModel):
    ...
    """ # noqa: E501
    account_identifier: StrictStr = Field(alias="accountIdentifier")
    supplier_currency: StrictStr = Field(alias="supplierCurrency")
    capture_currency: StrictStr = Field(alias="captureCurrency")
    supplier_amount: Union[StrictFloat, StrictInt] = Field(alias="supplierAmount")
    capture_amount: Union[StrictFloat, StrictInt] = Field(alias="captureAmount")
    __properties: ClassVar[List[str]] = ["accountIdentifier", "supplierCurrency", "captureCurrency", "supplierAmount", "captureAmount"]
