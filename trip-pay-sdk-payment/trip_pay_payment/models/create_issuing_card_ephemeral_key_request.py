...
class CreateIssuingCardEphemeralKeyRequest(BaseModel):
    """
    CreateIssuingCardEphemeralKeyRequest
    """ # noqa: E501
    vendor_identifier: StrictStr = Field(description="Which coverage area is Stripe customer occurring in.", alias="vendorIdentifier")
    issuing_card: StrictStr = Field(description="The cardholder unique ID.", alias="issuingCard")
    nonce: StrictStr = Field(description="A unique none.")
    __properties: ClassVar[List[str]] = ["vendorIdentifier", "issuingCard", "nonce"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "issuingCard": obj.get("issuingCard"),
            "nonce": obj.get("nonce")
        })
        return _obj
