...
class GeoNameLightweightPayment(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["geoNameId", "type", "name", "urlName", "asciiName", "location", "featureCode", "countryCode", "timezone", "country", "subCountry", "subSubCountry"]
