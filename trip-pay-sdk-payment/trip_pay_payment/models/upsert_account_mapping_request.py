...
class UpsertAccountMappingRequest(BaseModel):
    ...
    """ # noqa: E501
    local_account_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Local account identifier is the reactive identifier", alias="localAccountIdentifier")
