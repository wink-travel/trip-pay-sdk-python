...
class UpsertImageRequestAuthenticatedEntity(BaseModel):
    """
    UpsertImageRequestAuthenticatedEntity
    """ # noqa: E501
    image: Optional[SimpleMultimediaAuthenticatedEntity] = Field(default=None, description="Customize account with a custom image / profile picture.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "image": SimpleMultimediaAuthenticatedEntity.from_dict(obj["image"]) if obj.get("image") is not None else None
        })
        return _obj
