...
class KeyValuePairAuthenticatedEntity(BaseModel):
    """
    KeyValuePairAuthenticatedEntity
    """ # noqa: E501
    value: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The value that should be persisted.")
    label: Annotated[str, Field(min_length=1, strict=True)] = Field(description="English readable text of the value.")
