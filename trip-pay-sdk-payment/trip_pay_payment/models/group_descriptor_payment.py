...
class GroupDescriptorPayment(BaseModel):
    """
    GroupDescriptorPayment
    """ # noqa: E501
    var_field: Optional[StrictStr] = Field(default=None, description="Field to group data set on", alias="field")
    dir: Optional[StrictStr] = Field(default=None, description="Group sort direction")
    aggregates: Optional[List[AggregateDescriptorPayment]] = Field(default=None, description="Primitive aggregate data points")
    __properties: ClassVar[List[str]] = ["field", "dir", "aggregates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "field": obj.get("field"),
            "dir": obj.get("dir"),
            "aggregates": [AggregateDescriptorPayment.from_dict(_item) for _item in obj["aggregates"]] if obj.get("aggregates") is not None else None
        })
        return _obj
