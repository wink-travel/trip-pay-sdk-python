...
class PayableContractResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="TripPay supplierContractIdentifier for reactive widget")
    ...
    supplier_contract_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Unique supplierContractIdentifier used to track the contract. Create a UUID for this purpose.", alias="supplierContractIdentifier")
    supplier_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Supplier supplierContractIdentifier", alias="supplierIdentifier")
