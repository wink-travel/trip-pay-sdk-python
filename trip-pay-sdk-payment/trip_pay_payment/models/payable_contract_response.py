...
class PayableContractResponse(BaseModel):
    ...
    supplier_contract_identifier: StrictStr = Field(description="Unique supplierContractIdentifier used to track the contract. Create a UUID for this purpose.", alias="supplierContractIdentifier")
    supplier_identifier: StrictStr = Field(description="Supplier supplierContractIdentifier", alias="supplierIdentifier")
    supplier_name: StrictStr = Field(description="Supplier name", alias="supplierName")
    external_supplier_identifier: StrictStr = Field(description="Track supplier with its external supplier supplierContractIdentifier", alias="externalSupplierIdentifier")
