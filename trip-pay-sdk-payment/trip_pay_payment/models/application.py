...
class Application(BaseModel):
    ...
    user_identifier: UUID = Field(description="Unique user record identifier", alias="userIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["id", "userIdentifier", "ownerIdentifier", "ownerName", "name", "redirectUris", "clientId"]
