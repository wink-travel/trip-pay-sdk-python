...
class DailyRate(BaseModel):
    ...
    price: CustomMonetaryAmount = Field(description="The displayPrice of this item in the original displayPrice quoted in the TripPay contract.")
    display_price: CustomMonetaryAmount = Field(description="The displayPrice of this item converted to desired quote.", alias="displayPrice")
    supplier_price: CustomMonetaryAmount = Field(description="The displayPrice of this item converted to supplier quote.", alias="supplierPrice")
    ...
    capture_price: CustomMonetaryAmount = Field(description="The capturePrice of this item. The price we charged with the acquirer.", alias="capturePrice")
