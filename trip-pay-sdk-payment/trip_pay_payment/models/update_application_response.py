...
class UpdateApplicationResponse(BaseModel):
    ...
    redirect_uris: Optional[List[Any]] = Field(default=None, alias="redirectUris")
    __properties: ClassVar[List[str]] = ["id", "name", "ownerIdentifier", "ownerName", "ownerType", "redirectUris"]
