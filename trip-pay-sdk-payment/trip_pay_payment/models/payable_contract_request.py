...
class PayableContractRequest(BaseModel):
    """
    PayableContractRequest
    """ # noqa: E501
    user: AuthenticatedUser = Field(description="The user making the booking")
    affiliate_account_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="affiliate account making the request", alias="affiliateAccountIdentifier")
    affiliate_account_identifier_type: StrictStr = Field(description="Type of identifier this is", alias="affiliateAccountIdentifierType")
    display_currency: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The desired quote", alias="displayCurrency")
    contract_list: Annotated[List[PayableContractSupplier], Field(min_length=1, max_length=2147483647)] = Field(alias="contractList")
    ...
    source_url: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Where the booking originate from", alias="sourceUrl")
    ...
    __properties: ClassVar[List[str]] = ["user", "affiliateAccountIdentifier", "affiliateAccountIdentifierType", "displayCurrency", "contractList", "traceId", "redirectUrl", "sourceUrl", "metadata"]

    @field_validator('affiliate_account_identifier_type')
    def affiliate_account_identifier_type_validate_enum(cls, value):
        """Validates the enum"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "affiliateAccountIdentifier": obj.get("affiliateAccountIdentifier"),
            "affiliateAccountIdentifierType": obj.get("affiliateAccountIdentifierType"),
            "displayCurrency": obj.get("displayCurrency") if obj.get("displayCurrency") is not None else 'USD',
            "contractList": [PayableContractSupplier.from_dict(_item) for _item in obj["contractList"]] if obj.get("contractList") is not None else None,
