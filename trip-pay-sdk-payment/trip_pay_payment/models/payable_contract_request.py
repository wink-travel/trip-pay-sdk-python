...
class PayableContractRequest(BaseModel):
    ...
    affiliate_account_identifier: StrictStr = Field(description="affiliate account making the request", alias="affiliateAccountIdentifier")
    ...
    source_url: StrictStr = Field(description="Where the booking originate from", alias="sourceUrl")
