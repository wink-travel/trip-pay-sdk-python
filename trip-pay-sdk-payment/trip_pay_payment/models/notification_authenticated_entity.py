...
class NotificationAuthenticatedEntity(BaseModel):
    """
    ...
    user_identifier: UUID = Field(description="Owner identifier", alias="userIdentifier")
    managing_entity_identifier: Optional[UUID] = Field(default=None, description="ManagingEntity identifier", alias="managingEntityIdentifier")
    name: Optional[StrictStr] = Field(default=None, description="Owner name")
    ...
    message_template_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Message template", alias="messageTemplateId")
    subject: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Subject of message")
    body: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Subject of message")
    cta_url: Optional[StrictStr] = Field(default=None, description="Path to feature", alias="ctaUrl")
    read: Optional[StrictBool] = Field(default=None, description="AffiliateAccount read announcement")
    marked_as_removed: Optional[StrictBool] = Field(default=None, description="Message marked as removed", alias="markedAsRemoved")
    notify_via_email: Optional[StrictBool] = Field(default=None, description="Also send email announcement", alias="notifyViaEmail")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "userIdentifier", "managingEntityIdentifier", "name", "priority", "type", "recipientType", "messageTemplateId", "subject", "body", "ctaUrl", "read", "markedAsRemoved", "notifyViaEmail"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "read": obj.get("read"),
            "markedAsRemoved": obj.get("markedAsRemoved"),
