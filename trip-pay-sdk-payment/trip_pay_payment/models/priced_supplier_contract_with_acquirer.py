...
class PricedSupplierContractWithAcquirer(BaseModel):
    ...
    user: AuthenticatedUser = Field(description="The authenticated user that made the reactive request")
