...
class ActivityStream(BaseModel):
    ...
    i18n_key: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Localized key. Key will be used to generate text on the front-end. If comment is not populated, i18n is required.", alias="i18nKey")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "acl", "entityIdentifier", "emotion", "comment", "i18nKey", "attachmentId", "user"]
