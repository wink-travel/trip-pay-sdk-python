...
class ActivityStream(BaseModel):
    ...
    i18n_key: StrictStr = Field(description="Localized key. Key will be used to generate text on the front-end. If comment is not populated, i18n is required.", alias="i18nKey")
