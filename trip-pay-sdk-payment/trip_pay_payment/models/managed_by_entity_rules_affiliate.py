...
class ManagedByEntityRulesAffiliate(BaseModel):
    """
    ManagedByEntityRulesAffiliate
    """ # noqa: E501
    expires: Optional[date] = Field(default=None, description="Optional expiration date when agency is no longer managing this entity.")
    num_bookings: Optional[StrictInt] = Field(default=None, description="Optional total number of bookings [left] the agency is entitled to commission. This number will decrement every time a booking is made with this agency involved.", alias="numBookings")
    non_expired: Optional[StrictBool] = Field(default=None, description="Whether managing entity rules has expired.", alias="nonExpired")
    __properties: ClassVar[List[str]] = ["expires", "numBookings", "nonExpired"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "numBookings": obj.get("numBookings"),
