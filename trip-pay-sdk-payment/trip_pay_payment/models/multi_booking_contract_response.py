...
class MultiBookingContractResponse(BaseModel):
    """
    MultiBookingContractResponse
    """ # noqa: E501
    list: Annotated[List[BookingContract], Field(min_length=1, max_length=2147483647)] = Field(description="Finalized booking contract")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [BookingContract.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
