...
class BookingContract(BaseModel):
    ...
    canceller_user_identifier: Optional[StrictStr] = Field(default=None, description="UserLightweight identifier that cancelled the entity.", alias="cancellerUserIdentifier")
