...
class BookingContract(BaseModel):
    ...
    identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Unique identifier used to track the contract.")
    ...
    display_price_quote: QuoteLightweight = Field(description="The quote used to create displayAmount.", alias="displayPriceQuote")
    supplier_price_quote: QuoteLightweight = Field(description="The quote used to create supplierAmount.", alias="supplierPriceQuote")
    internal_price_quote: QuoteLightweight = Field(description="The quote used to create internalAmount.", alias="internalPriceQuote")
    capture_price_quote: QuoteLightweight = Field(description="The quote used to create captureAmount.", alias="capturePriceQuote")
    item_list: Annotated[List[BookingContractItem], Field(min_length=1, max_length=2147483647)] = Field(description="Holds one booking line item for a specific supplier.", alias="itemList")
    external_supplier_identifier: Optional[StrictStr] = Field(default=None, description="Contract creator can choose to identify this record with her own identifier", alias="externalSupplierIdentifier")
    external_supplier_booking_code: Optional[StrictStr] = Field(default=None, description="External booking code generated by the caller", alias="externalSupplierBookingCode")
    payment: BookingContractPaymentDetails = Field(description="Details of the payment. Payment details will be empty if account type is AGENT")
    cancelled: StrictBool = Field(description="Whether the booking was cancelled.")
    ...
    funds_processed: Optional[StrictBool] = Field(default=None, description="Whether all funds have been processed for this booking.", alias="fundsProcessed")
    refunds: Optional[List[Refund]] = None
    payouts: Optional[List[Payout]] = None
    ...
    total_fees_and_commissions_in_percent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total fees + commissions in percent", alias="totalFeesAndCommissionsInPercent")
    original_fees_in_percent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Platform fee in percent", alias="originalFeesInPercent")
    ...
    net_total_customers_source_amount: Optional[CustomMonetaryAmount] = Field(default=None, description="Returns the total amount in source currency minus TripPay fee.", alias="netTotalCustomersSourceAmount")
    net_total_customers_capture_amount: Optional[CustomMonetaryAmount] = Field(default=None, description="Returns the total amount in capture currency minus TripPay fee.", alias="netTotalCustomersCaptureAmount")
    net_total_customers_display_amount: Optional[CustomMonetaryAmount] = Field(default=None, description="Returns the total amount in display currency minus TripPay fee.", alias="netTotalCustomersDisplayAmount")
    net_total_customers_supplier_amount: Optional[CustomMonetaryAmount] = Field(default=None, description="Returns the total amount in supplier currency minus TripPay fee.", alias="netTotalCustomersSupplierAmount")
    net_total_customers_internal_amount: Optional[CustomMonetaryAmount] = Field(default=None, description="Returns the total amount in internal currency minus TripPay fee.", alias="netTotalCustomersInternalAmount")
    ...
    net_total_affiliate_agency_fees_source_amount: Optional[CustomMonetaryAmount] = Field(default=None, description="Returns the net total amount in source currency owed affiliate agency.", alias="netTotalAffiliateAgencyFeesSourceAmount")
    net_total_affiliate_agency_fees_capture_amount: Optional[CustomMonetaryAmount] = Field(default=None, description="Returns the net total amount in capture currency owed affiliate agency.", alias="netTotalAffiliateAgencyFeesCaptureAmount")
    net_total_affiliate_agency_fees_display_amount: Optional[CustomMonetaryAmount] = Field(default=None, description="Returns the net total amount in display currency owed affiliate agency.", alias="netTotalAffiliateAgencyFeesDisplayAmount")
    net_total_affiliate_agency_fees_supplier_amount: Optional[CustomMonetaryAmount] = Field(default=None, description="Returns the net total amount in supplier currency owed affiliate agency.", alias="netTotalAffiliateAgencyFeesSupplierAmount")
    net_total_affiliate_agency_fees_internal_amount: Optional[CustomMonetaryAmount] = Field(default=None, description="Returns the net total amount in internal currency owed affiliate agency.", alias="netTotalAffiliateAgencyFeesInternalAmount")
    net_total_supplier_agency_fees_source_amount: Optional[CustomMonetaryAmount] = Field(default=None, description="Returns the net total amount in source currency owed supplier agency.", alias="netTotalSupplierAgencyFeesSourceAmount")
    net_total_supplier_agency_fees_capture_amount: Optional[CustomMonetaryAmount] = Field(default=None, description="Returns the net total amount in capture currency owed supplier agency.", alias="netTotalSupplierAgencyFeesCaptureAmount")
    net_total_supplier_agency_fees_display_amount: Optional[CustomMonetaryAmount] = Field(default=None, description="Returns the net total amount in display currency owed supplier agency.", alias="netTotalSupplierAgencyFeesDisplayAmount")
    net_total_supplier_agency_fees_supplier_amount: Optional[CustomMonetaryAmount] = Field(default=None, description="Returns the net total amount in supplier currency owed supplier agency.", alias="netTotalSupplierAgencyFeesSupplierAmount")
    net_total_supplier_agency_fees_internal_amount: Optional[CustomMonetaryAmount] = Field(default=None, description="Returns the net total amount in internal currency owed supplier agency.", alias="netTotalSupplierAgencyFeesInternalAmount")
    ...
    total_funds_grouped_by_beneficiary: Optional[List[Beneficiary]] = Field(default=None, description="Returns all the beneficiaries in this contract with their total amounts", alias="totalFundsGroupedByBeneficiary")
    total_tokens_earned: Optional[StrictInt] = Field(default=None, description="Sums up all tokens earned on the contract", alias="totalTokensEarned")
    ...
    cancellable_with_potential_charges: Optional[StrictBool] = Field(default=None, description="Whether a cancellation comes with partial charges. I.e. Only some of the items in contract are not fully refundable.", alias="cancellableWithPotentialCharges")
    cancellable_by_supplier_or_agent: Optional[StrictBool] = Field(default=None, description="Whether the booking can still be cancelled completely by the supplier.", alias="cancellableBySupplierOrAgent")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BookingContract from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BookingContract from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "itemList": [BookingContractItem.from_dict(_item) for _item in obj["itemList"]] if obj.get("itemList") is not None else None,
            ...
            "payment": BookingContractPaymentDetails.from_dict(obj["payment"]) if obj.get("payment") is not None else None,
            ...
            "totalFundsGroupedByBeneficiary": [Beneficiary.from_dict(_item) for _item in obj["totalFundsGroupedByBeneficiary"]] if obj.get("totalFundsGroupedByBeneficiary") is not None else None,
