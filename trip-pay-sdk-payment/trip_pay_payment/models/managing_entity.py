...
class ManagingEntity(BaseModel):
    ...
    """ # noqa: E501
    value: StrictStr = Field(description="The value that should be persisted.")
    label: StrictStr = Field(description="Text representation of the value.")
    type: StrictStr = Field(description="Type of entity.")
    __properties: ClassVar[List[str]] = ["value", "label", "type"]
