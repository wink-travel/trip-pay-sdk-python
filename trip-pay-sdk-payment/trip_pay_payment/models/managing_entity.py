...
class ManagingEntity(BaseModel):
    ...
    sub_type: StrictStr = Field(description="This is for Wink entities only. Does not apply to TripPay.", alias="subType")
    url_name: Optional[StrictStr] = Field(default=None, description="Entity url slug if available.", alias="urlName")
    image_identifier: Optional[StrictStr] = Field(default=None, description="Entity account icon if available.", alias="imageIdentifier")
    price_lookup_key: Optional[StrictStr] = Field(default=None, description="price lookup key", alias="priceLookupKey")
    __properties: ClassVar[List[str]] = ["identifier", "name", "type", "subType", "urlName", "imageIdentifier", "priceLookupKey"]
    ...
    def price_lookup_key_validate_enum(cls, value):
        ...
        if value not in set(['STARTER_MONTHLY', 'STARTER_YEARLY', 'GROWTH_MONTHLY', 'GROWTH_YEARLY', 'ELITE_MONTHLY', 'ELITE_YEARLY']):
            raise ValueError("must be one of enum values ('STARTER_MONTHLY', 'STARTER_YEARLY', 'GROWTH_MONTHLY', 'GROWTH_YEARLY', 'ELITE_MONTHLY', 'ELITE_YEARLY')")
        return value
