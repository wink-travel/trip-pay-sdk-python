...
class ManagingEntity(BaseModel):
    """
    ManagingEntity
    """ # noqa: E501
    identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The value that should be persisted.")
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Text representation of the value.")
    type: StrictStr = Field(description="Type of entity.")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Metadata")
    __properties: ClassVar[List[str]] = ["identifier", "name", "type", "metadata"]
