...
class ManagingEntity(BaseModel):
    ...
    """ # noqa: E501
    identifier: StrictStr = Field(description="The value that should be persisted.")
    name: StrictStr = Field(description="Text representation of the value.")
    ...
    __properties: ClassVar[List[str]] = ["identifier", "name", "type", "subType"]
