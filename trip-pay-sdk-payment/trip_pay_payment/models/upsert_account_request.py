...
class UpsertAccountRequest(BaseModel):
    ...
    """ # noqa: E501
    owner_type_identifier: Optional[StrictStr] = Field(default=None, description="Account phone number is mostly used for KYC purchases", alias="ownerTypeIdentifier")
    dob: Optional[date] = Field(default=None, description="Account's main currency.")
    ...
    __properties: ClassVar[List[str]] = ["ownerTypeIdentifier", "dob", "preferredDisbursementType"]
