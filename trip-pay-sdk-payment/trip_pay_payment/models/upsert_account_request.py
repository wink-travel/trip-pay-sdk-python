...
class UpsertAccountRequest(BaseModel):
    ...
    url: Annotated[str, Field(min_length=1, strict=True)] = Field(description="AffiliateAccountLightweight website. If private person with no personal website, link to main social network account.")
    account_email: Annotated[str, Field(min_length=1, strict=True)] = Field(description="AffiliateAccountLightweight website. If private person with no personal website, link to main social network account.", alias="accountEmail")
