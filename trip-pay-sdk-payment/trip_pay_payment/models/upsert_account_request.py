...
class UpsertAccountRequest(BaseModel):
    ...
    account_email: Annotated[str, Field(min_length=1, strict=True)] = Field(description="AffiliateAccount website. If private person with no personal website, link to main social network account.", alias="accountEmail")
    ...
    address: UpsertAddressRequest = Field(description="Account address. Usually the business address")
