...
class UpdateAccountRepresentativeRequestAuthenticatedEntity(BaseModel):
    """
    UpdateAccountRepresentativeRequestAuthenticatedEntity
    """ # noqa: E501
    account_email: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Account email", alias="accountEmail")
    account_phone_number: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Account phone number", alias="accountPhoneNumber")
    __properties: ClassVar[List[str]] = ["accountEmail", "accountPhoneNumber"]
