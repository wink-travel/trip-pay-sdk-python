...
class SetTaxIdentifierRequest(BaseModel):
    """
    SetTaxIdentifierRequest
    """ # noqa: E501
    tax_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Updated tax identifier. I.e. SSN", alias="taxId")
    __properties: ClassVar[List[str]] = ["taxId"]
