...
class PricedSupplierContractItemWithAcquirer(BaseModel):
    """
    ...
    display_price: CustomMonetaryAmount = Field(description="The displayPrice of this item.", alias="displayPrice")
    supplier_price: CustomMonetaryAmount = Field(description="The supplierPrice of this item. How it was captured by the acquirer.", alias="supplierPrice")
    internal_price: CustomMonetaryAmount = Field(description="The internalPrice of this item. The price in platform currency.", alias="internalPrice")
    capture_price: CustomMonetaryAmount = Field(description="The capturePrice of this item. The price in capture currency.", alias="capturePrice")
    ...
    __properties: ClassVar[List[str]] = ["user", "nameInEnglish", "descriptionInEnglish", "price", "displayPrice", "supplierPrice", "internalPrice", "capturePrice", "itinerary", "pricingType", "type", "beneficiaryList", "payable", "policy", "externalIdentifier", "dailyRateList", "metadata"]
