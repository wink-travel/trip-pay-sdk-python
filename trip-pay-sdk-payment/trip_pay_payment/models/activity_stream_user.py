...
class ActivityStreamUser(BaseModel):
    ...
    """ # noqa: E501
    user_identifier: StrictStr = Field(description="User ID of authenticated person that created the stream.", alias="userIdentifier")
    name: StrictStr = Field(description="Full name of user.")
