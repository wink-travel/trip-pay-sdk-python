...
class ActivityStreamUser(BaseModel):
    """
    ActivityStreamUser
    """ # noqa: E501
    user_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="User ID of authenticated person that created the stream.", alias="userIdentifier")
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Full name of user.")
    profile_picture_url: Optional[StrictStr] = Field(default=None, description="Optional url of user's profile picture", alias="profilePictureUrl")
    __properties: ClassVar[List[str]] = ["userIdentifier", "name", "profilePictureUrl"]
