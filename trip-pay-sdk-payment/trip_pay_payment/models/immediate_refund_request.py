...
class ImmediateRefundRequest(BaseModel):
    """
    ImmediateRefundRequest
    """ # noqa: E501
    description: Annotated[str, Field(min_length=1, strict=True)] = Field(description="A description of why an immediate refunds was requested.")
