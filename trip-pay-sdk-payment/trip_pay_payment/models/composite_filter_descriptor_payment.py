...
class CompositeFilterDescriptorPayment(BaseModel):
    """
    CompositeFilterDescriptorPayment
    """ # noqa: E501
    logic: Optional[StrictStr] = Field(default=None, description="Whether to filter inclusively or exclusively")
    filters: Optional[List[FilterDescriptorPayment]] = Field(default=None, description="Descriptors used for filtering the result set")
    __properties: ClassVar[List[str]] = ["logic", "filters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "logic": obj.get("logic"),
            "filters": [FilterDescriptorPayment.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None
        })
        return _obj
