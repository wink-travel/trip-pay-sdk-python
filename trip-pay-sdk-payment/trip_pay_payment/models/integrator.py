...
class Integrator(BaseModel):
    ...
    """ # noqa: E501
    identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Unique identifier.")
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Integrator.")
    ...
    currency_code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Currency in coverage region.", alias="currencyCode")
    credentials: Annotated[List[AcquirerCredentials], Field(min_length=1)]
    ...
    __properties: ClassVar[List[str]] = ["identifier", "name", "priority", "vendor", "type", "currencyCode", "credentials", "webhookSecret", "publicToken"]
