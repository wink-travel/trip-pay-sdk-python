...
class UpsertWebhookRequest(BaseModel):
    """
    UpsertWebhookRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Descriptive name of webhook.")
    entity: UpsertWebhookManagingEntityRequest = Field(description="Name of the application.")
    ...
    __properties: ClassVar[List[str]] = ["name", "entity", "enabled", "eventUrl", "eventList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "entity": UpsertWebhookManagingEntityRequest.from_dict(obj["entity"]) if obj.get("entity") is not None else None,
