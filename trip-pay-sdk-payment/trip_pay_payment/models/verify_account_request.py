...
class VerifyAccountRequest(BaseModel):
    ...
    """ # noqa: E501
    address: Optional[UpsertAddressRequest] = Field(default=None, description="Confirmed address.")
    owner_type: Optional[StrictStr] = Field(default=None, description="Whether the account is a company or individual.", alias="ownerType")
    owner_type_identifier: Optional[StrictStr] = Field(default=None, description="Either the TIN (individual) or the EIN (company) number of the individual.", alias="ownerTypeIdentifier")
    dob: Optional[date] = Field(default=None, description="Date of birth in the case of an individual.")
    disbursement_type: Optional[StrictStr] = Field(default=None, description="The method which the account holder whishes to be paid.", alias="disbursementType")
    vat_id: Optional[StrictStr] = Field(default=None, description="An optional VAT ID", alias="vatID")
    __properties: ClassVar[List[str]] = ["address", "ownerType", "ownerTypeIdentifier", "dob", "disbursementType", "vatID"]
