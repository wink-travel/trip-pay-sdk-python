...
class BeneficiaryAggregateData(BaseModel):
    ...
    """ # noqa: E501
    account_identifier: StrictStr = Field(description="Beneficiary account identifier", alias="accountIdentifier")
    account_name: StrictStr = Field(description="Beneficiary account name", alias="accountName")
