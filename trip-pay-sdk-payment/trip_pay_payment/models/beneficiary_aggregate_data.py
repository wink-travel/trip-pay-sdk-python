...
class BeneficiaryAggregateData(BaseModel):
    """
    BeneficiaryAggregateData
    """ # noqa: E501
    account_identifier: UUID = Field(description="Beneficiary account identifier", alias="accountIdentifier")
    account_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Beneficiary account name", alias="accountName")
    type: StrictStr = Field(description="Type of payment to beneficiary")
    total_items_sold: StrictInt = Field(description="Total items sold", alias="totalItemsSold")
    ...
    supplier_amount: Union[StrictFloat, StrictInt] = Field(description="Amount sold in supplier currency", alias="supplierAmount")
    internal_amount: Union[StrictFloat, StrictInt] = Field(description="Amount sold in internal currency", alias="internalAmount")
    __properties: ClassVar[List[str]] = ["accountIdentifier", "accountName", "type", "totalItemsSold", "supplierCurrency", "internalCurrency", "supplierAmount", "internalAmount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "totalItemsSold": obj.get("totalItemsSold"),
