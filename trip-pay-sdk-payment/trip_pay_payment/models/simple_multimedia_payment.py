...
class SimpleMultimediaPayment(BaseModel):
    """
    Multimedia that contains less information than Multimedia object
    """ # noqa: E501
    multimedia_identifier: UUID = Field(description="Document identifier", alias="multimediaIdentifier")
    ...
    descriptions: Optional[List[SimpleDescription]] = Field(default=None, description="Localized media captions to give user some context about where this media was taken.")
    ...
    attribution: Optional[List[MediaAuthorAttribution]] = Field(default=None, description="Whether image has attribution properties")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SimpleMultimediaPayment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SimpleMultimediaPayment from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "descriptions": [SimpleDescription.from_dict(_item) for _item in obj["descriptions"]] if obj.get("descriptions") is not None else None,
            "lifestyleType": obj.get("lifestyleType"),
            "attribution": [MediaAuthorAttribution.from_dict(_item) for _item in obj["attribution"]] if obj.get("attribution") is not None else None,
