...
class InviteManagerRequestAffiliate(BaseModel):
    """
    InviteManagerRequestAffiliate
    """ # noqa: E501
    email: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Existing user account email to make manager")
