...
class UpsertWebhookManagingEntityRequest(BaseModel):
    """
    UpsertWebhookManagingEntityRequest
    """ # noqa: E501
    identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Managing entity identifier.")
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Descriptive name of managing entity.")
