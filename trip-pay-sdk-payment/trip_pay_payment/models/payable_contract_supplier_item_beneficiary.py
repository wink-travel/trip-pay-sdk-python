...
class PayableContractSupplierItemBeneficiary(BaseModel):
    """
    PayableContractSupplierItemBeneficiary is a registered account with rights to compensation within a booking.
    """ # noqa: E501
    identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="identifier of beneficiary that can map to an account with us")
    identifier_type: StrictStr = Field(description="The identifierType tells us what type of identifier this is", alias="identifierType")
    amount_due: BeneficiaryCharge = Field(alias="amountDue")
    ...
    __properties: ClassVar[List[str]] = ["identifier", "identifierType", "amountDue", "type", "metadata"]
