...
class Contact(BaseModel):
    ...
    email: Optional[StrictStr] = Field(default=None, description="Contact E-mail")
    ...
    full_name: Optional[StrictStr] = Field(default=None, description="First and last name", alias="fullName")
    summary: Optional[StrictStr] = Field(default=None, description="Summary")
    __properties: ClassVar[List[str]] = ["firstName", "lastName", "email", "secondaryEmail", "phoneNumber", "fullName", "summary"]
