...
class PageManagingEntityPayment(BaseModel):
    """
    ...
    content: Optional[List[ManagingEntityPayment]] = None
    ...
    pageable: Optional[PageableObjectPayment] = None
    sort: Optional[SortObjectPayment] = None
    empty: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["totalPages", "totalElements", "size", "content", "number", "first", "last", "numberOfElements", "pageable", "sort", "empty"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [ManagingEntityPayment.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "number": obj.get("number"),
            "first": obj.get("first"),
            "last": obj.get("last"),
            "numberOfElements": obj.get("numberOfElements"),
            "pageable": PageableObjectPayment.from_dict(obj["pageable"]) if obj.get("pageable") is not None else None,
            "sort": SortObjectPayment.from_dict(obj["sort"]) if obj.get("sort") is not None else None,
            "empty": obj.get("empty")
        })
        return _obj
