...
class ManagerInviteAffiliate(BaseModel):
    """
    ManagerInviteAffiliate
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="AffiliateAccount ID")
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="AffiliateAccount name")
    image_identifier: Optional[StrictStr] = Field(default=None, description="Image ID if available", alias="imageIdentifier")
    __properties: ClassVar[List[str]] = ["id", "name", "imageIdentifier"]
