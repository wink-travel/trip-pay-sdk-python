...
class ChangeManagingEntityNameRequestAuthenticatedEntity(BaseModel):
    """
    ChangeManagingEntityNameRequestAuthenticatedEntity
    """ # noqa: E501
    trade_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Doing business as name.", alias="tradeName")
    legal_name: Optional[StrictStr] = Field(default=None, description="Hotel chain name if property is part of that chain.", alias="legalName")
    __properties: ClassVar[List[str]] = ["tradeName", "legalName"]
