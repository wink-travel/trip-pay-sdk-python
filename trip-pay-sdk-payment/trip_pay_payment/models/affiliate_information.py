...
class AffiliateInformation(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "affiliateIdentifier": obj.get("affiliateIdentifier"),
            "affiliateName": obj.get("affiliateName"),
            "affiliateUrl": obj.get("affiliateUrl")
        })
        return _obj
