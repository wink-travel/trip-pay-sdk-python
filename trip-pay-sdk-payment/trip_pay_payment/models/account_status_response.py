...
class AccountStatusResponse(BaseModel):
    ...
    task_list: Optional[List[AccountStatusEntry]] = Field(default=None, alias="taskList")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in task_list (list)
        _items = []
        if self.task_list:
            for _item_task_list in self.task_list:
                if _item_task_list:
                    _items.append(_item_task_list.to_dict())
            _dict['taskList'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "taskList": [AccountStatusEntry.from_dict(_item) for _item in obj["taskList"]] if obj.get("taskList") is not None else None
        })
        return _obj
