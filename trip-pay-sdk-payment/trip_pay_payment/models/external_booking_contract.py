...
class ExternalBookingContract(BaseModel):
    """
    ExternalBookingContract
    """ # noqa: E501
    mapping: Mapping = Field(description="The mapped account entity")
    booking_contract: BookingContract = Field(description="The booking contract", alias="bookingContract")
    __properties: ClassVar[List[str]] = ["mapping", "bookingContract"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mapping": Mapping.from_dict(obj["mapping"]) if obj.get("mapping") is not None else None,
            "bookingContract": BookingContract.from_dict(obj["bookingContract"]) if obj.get("bookingContract") is not None else None
        })
        return _obj
