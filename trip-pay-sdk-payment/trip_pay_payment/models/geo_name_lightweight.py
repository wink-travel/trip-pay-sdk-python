...
class GeoNameLightweight(BaseModel):
    ...
    country: Optional[CountryLightweight] = Field(default=None, description="CountryLightweight")
    sub_country: Optional[SubCountryLightweight] = Field(default=None, description="CountryLightweight sub division", alias="subCountry")
    sub_sub_country: Optional[SubSubCountryLightweight] = Field(default=None, description="CountryLightweight sub sub division", alias="subSubCountry")
