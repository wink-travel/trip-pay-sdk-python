...
class PendingRefund(BaseModel):
    ...
    PendingRefund
    """ # noqa: E501
    refund_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="This is the refund identifier located on the root bookingContract.refunds object", alias="refundIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["refundIdentifier", "sourceAmountRefundModifier", "displayAmountRefundModifier", "supplierAmountRefundModifier", "internalAmountRefundModifier", "captureAmountRefundModifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "refundIdentifier": obj.get("refundIdentifier"),
