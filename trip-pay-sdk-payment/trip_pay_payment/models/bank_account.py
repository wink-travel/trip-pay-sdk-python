...
class BankAccount(BaseModel):
    ...
    swift_code: Optional[StrictStr] = Field(default=None, description="Bank SWIFT code. Unique code identifier the bank and branch of the bank account.", alias="swiftCode")
    routing_number: Optional[StrictStr] = Field(default=None, description="Bank account routing number. This is sort code in HK and Zengin code in JP.", alias="routingNumber")
    account_number: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Bank account number. In all EU countries, this would be the IBAN. In other countries, the routing number will apply as well.", alias="accountNumber")
    primary: StrictBool = Field(description="One bank account always needs to be primary.")
    __properties: ClassVar[List[str]] = ["identifier", "countryCode", "currencyCode", "accountHolderName", "swiftCode", "routingNumber", "accountNumber", "primary"]
