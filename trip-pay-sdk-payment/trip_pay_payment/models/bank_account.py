...
class BankAccount(BaseModel):
    ...
    """ # noqa: E501
    identifier: StrictStr = Field(description="Unique bank account identifier")
    country_code: StrictStr = Field(description="Country of bank account", alias="countryCode")
    currency_code: StrictStr = Field(description="Currency of bank account", alias="currencyCode")
    account_holder_name: StrictStr = Field(description="Bank account holder name", alias="accountHolderName")
    ...
    account_number: StrictStr = Field(description="Bank account number. In all EU countries, this would be the IBAN. In other countries, the routing number will apply as well.", alias="accountNumber")
