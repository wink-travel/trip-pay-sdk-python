...
class CountResponseAuthenticatedEntity(BaseModel):
    """
    CountResponseAuthenticatedEntity
    """ # noqa: E501
    success: StrictBool = Field(description="True if count query worked.")
    count: StrictInt = Field(description="Number of reviews for this property.")
