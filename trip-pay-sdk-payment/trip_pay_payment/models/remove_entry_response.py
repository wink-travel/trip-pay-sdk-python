...
class RemoveEntryResponse(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Identifier of removed document")
    success: Optional[StrictBool] = Field(default=None, description="Whether the removal was successful or not.")
    message: Optional[StrictStr] = Field(default=None, description="Message with additional information; mostly if the removal request was a failure.")
    __properties: ClassVar[List[str]] = ["id", "success", "message"]
