...
class UpdateManagingEntityInformationRequestAuthenticatedEntity(BaseModel):
    """
    UpdateManagingEntityInformationRequestAuthenticatedEntity
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Name of account")
    legal_name: Optional[StrictStr] = Field(default=None, description="Legal name of entity if other than name", alias="legalName")
    description: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Short description of entity")
    __properties: ClassVar[List[str]] = ["name", "legalName", "description"]
