...
class UpsertApplicationRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Name of the application.")
    ...
    redirect_uris: Annotated[List[Any], Field(min_length=1)] = Field(alias="redirectUris")
    __properties: ClassVar[List[str]] = ["name", "ownerIdentifier", "ownerName", "ownerType", "redirectUris"]
