...
class UpsertApplicationRequest(BaseModel):
    ...
    redirect_uris: Annotated[List[StrictStr], Field(min_length=1)] = Field(alias="redirectUris")
    __properties: ClassVar[List[str]] = ["name", "ownerIdentifier", "ownerName", "redirectUris"]
