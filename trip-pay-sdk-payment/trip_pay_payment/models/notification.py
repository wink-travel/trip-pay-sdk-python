...
class Notification(BaseModel):
    ...
    cta_url: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Path to feature", alias="ctaUrl")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "ownerIdentifier", "priority", "type", "recipientType", "application", "messageTemplateId", "subject", "body", "ctaUrl", "read", "markedAsRemoved", "notifyViaEmail"]
