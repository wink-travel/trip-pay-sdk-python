...
class Notification(BaseModel):
    ...
    Notification
    """ # noqa: E501
    identifier: StrictStr = Field(description="Notification identifier")
    owner_identifier: StrictStr = Field(description="Owner identifier", alias="ownerIdentifier")
    ...
    message_template_id: StrictStr = Field(description="Message template", alias="messageTemplateId")
    subject: StrictStr = Field(description="Subject of message")
    body: StrictStr = Field(description="Subject of message")
    cta_url: StrictStr = Field(description="Path to feature", alias="ctaUrl")
    read: Optional[StrictBool] = Field(default=None, description="Company read announcement")
    ...
    __properties: ClassVar[List[str]] = ["identifier", "ownerIdentifier", "priority", "type", "recipientType", "application", "messageTemplateId", "subject", "body", "ctaUrl", "read", "markedAsRemoved", "notifyViaEmail"]
