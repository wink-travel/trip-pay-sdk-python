...
class ActivityStreamApi:
    ...
    def create_activity(
        self,
        upsert_activity_stream_request: UpsertActivityStreamRequest,
        ...
        :param upsert_activity_stream_request: (required)
        :type upsert_activity_stream_request: UpsertActivityStreamRequest
        :param wink_version:
        ...
        _param = self._create_activity_serialize(
            upsert_activity_stream_request=upsert_activity_stream_request,
    ...
    def _create_activity_serialize(
        self,
        upsert_activity_stream_request,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        if upsert_activity_stream_request is not None:
            _body_params = upsert_activity_stream_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/activity-stream',
    ...
    def show_stream(
        ...
        _param = self._show_stream_serialize(
    ...
    @validate_call
    def show_stream_with_http_info(
        self,
        entity_identifier: Annotated[StrictStr, Field(description="ID of entity to retrieve stream for")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def show_stream_without_preload_content(
        self,
        entity_identifier: Annotated[StrictStr, Field(description="ID of entity to retrieve stream for")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _show_stream_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/activity-stream/{entityIdentifier}/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
