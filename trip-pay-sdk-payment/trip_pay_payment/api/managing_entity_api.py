...
class ManagingEntityApi:
    ...
    def show_managing_entities(
        self,
        managing_entity_identifier: Annotated[StrictStr, Field(description="Managing entity ID")],
        ...
        :param managing_entity_identifier: Managing entity ID (required)
    ...
    def show_managing_entities1(
        ...
        _param = self._show_managing_entities1_serialize(
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def show_managing_entities1_with_http_info(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ManagingEntity]]:
        """Show Managing Entities
    ...
    @validate_call
    def show_managing_entities1_without_preload_content(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _show_managing_entities1_serialize(
        self,
        wink_version,
        accept,
        _request_auth,
