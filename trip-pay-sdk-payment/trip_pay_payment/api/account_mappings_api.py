...
class AccountMappingsApi:
    ...
    def find_account_mapping(
        ...
        _param = self._find_account_mapping_serialize(
            account_identifier=account_identifier,
            id=id,
            wink_version=wink_version,
            accept=accept,
    ...
    @validate_call
    def find_account_mapping_with_http_info(
        self,
        account_identifier: StrictStr,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
    ...
    @validate_call
    def find_account_mapping_without_preload_content(
        self,
        account_identifier: StrictStr,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
    ...
    def _find_account_mapping_serialize(
        self,
        account_identifier,
        id,
        wink_version,
    ...
    def show_account_mapping_grid(
        ...
        _param = self._show_account_mapping_grid_serialize(
            account_identifier=account_identifier,
            state=state,
            wink_version=wink_version,
            _request_auth=_request_auth,
    ...
    @validate_call
    def show_account_mapping_grid_with_http_info(
        self,
        account_identifier: StrictStr,
        state: State,
        wink_version: Optional[StrictStr] = None,
    ...
    @validate_call
    def show_account_mapping_grid_without_preload_content(
        self,
        account_identifier: StrictStr,
        state: State,
        wink_version: Optional[StrictStr] = None,
    ...
    def _show_account_mapping_grid_serialize(
        self,
        account_identifier,
        state,
        wink_version,
