...
class AffiliateApi:
    ...
    @validate_call
    def show_affiliate_details(
        self,
        affiliate_details_request: AffiliateDetailsRequest,
        ...
        :param affiliate_details_request: (required)
        :type affiliate_details_request: AffiliateDetailsRequest
        :param wink_version:
        ...
        _param = self._show_affiliate_details_serialize(
            affiliate_details_request=affiliate_details_request,
    ...
    @validate_call
    def show_affiliate_details_with_http_info(
        self,
        affiliate_details_request: AffiliateDetailsRequest,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AffiliateInformation]:
        """Show Affiliate Details
    ...
    @validate_call
    def show_affiliate_details_without_preload_content(
        self,
        affiliate_details_request: AffiliateDetailsRequest,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _show_affiliate_details_serialize(
        self,
        ...
        if affiliate_details_request is not None:
            _body_params = affiliate_details_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/contract/affiliate/details',
