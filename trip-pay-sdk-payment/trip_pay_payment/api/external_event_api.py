...
class ExternalEventApi:
    ...
    @validate_call
    def show_external_event(
        self,
        event_identifier: Annotated[StrictStr, Field(description="ID of event to retrieve")],
        ...
        :param event_identifier: ID of event to retrieve (required)
        ...
        _param = self._show_external_event_serialize(
    ...
    @validate_call
    def show_external_event_with_http_info(
        self,
        event_identifier: Annotated[StrictStr, Field(description="ID of event to retrieve")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def show_external_event_without_preload_content(
        self,
        event_identifier: Annotated[StrictStr, Field(description="ID of event to retrieve")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _show_external_event_serialize(
        self,
        event_identifier,
        wink_version,
        accept,
        ...
        if event_identifier is not None:
            _path_params['eventIdentifier'] = event_identifier
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/administration/external-event/{eventIdentifier}',
    ...
    def show_external_event_grid(
        ...
        _param = self._show_external_event_grid_serialize(
            state=state,
            wink_version=wink_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def show_external_event_grid_with_http_info(
        self,
        state: State,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def show_external_event_grid_without_preload_content(
        self,
        state: State,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _show_external_event_grid_serialize(
        self,
        state,
        wink_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/administration/external-event/grid',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def show_external_event_list(
        self,
        entity_identifier: Annotated[StrictStr, Field(description="ID of entity to retrieve stream for")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        :param entity_identifier: ID of entity to retrieve stream for (required)
        ...
        _param = self._show_external_event_list_serialize(
    ...
    @validate_call
    def show_external_event_list_with_http_info(
        self,
        entity_identifier: Annotated[StrictStr, Field(description="ID of entity to retrieve stream for")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ExternalEvent]]:
        """Show External Events
    ...
    @validate_call
    def show_external_event_list_without_preload_content(
        self,
        entity_identifier: Annotated[StrictStr, Field(description="ID of entity to retrieve stream for")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _show_external_event_list_serialize(
        self,
        entity_identifier,
        wink_version,
        accept,
        ...
        if entity_identifier is not None:
            _path_params['entityIdentifier'] = entity_identifier
        # process the query parameters
        # process the header parameters
        if wink_version is not None:
            _header_params['Wink-Version'] = wink_version
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/administration/external-event/{entityIdentifier}/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
