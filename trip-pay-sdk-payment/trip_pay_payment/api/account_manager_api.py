...
class AccountManagerApi:
    ...
    def invite_manager(
        self,
        invite_manager_request_affiliate: InviteManagerRequestAffiliate,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._invite_manager_serialize(
            invite_manager_request_affiliate=invite_manager_request_affiliate,
            wink_version=wink_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def invite_manager_with_http_info(
        self,
        invite_manager_request_affiliate: InviteManagerRequestAffiliate,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def invite_manager_without_preload_content(
        self,
        invite_manager_request_affiliate: InviteManagerRequestAffiliate,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _invite_manager_serialize(
        self,
        invite_manager_request_affiliate,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if invite_manager_request_affiliate is not None:
            _body_params = invite_manager_request_affiliate
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/api/manager/invite',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def remove_company_user(
        ...
        _param = self._remove_company_user_serialize(
            email=email,
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
    ...
    @validate_call
    def remove_company_user_with_http_info(
        self,
        email: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def remove_company_user_without_preload_content(
        self,
        email: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _remove_company_user_serialize(
        self,
        email,
        wink_version,
        accept,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/manager/{email}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def remove_manager_agency(
        ...
        _param = self._remove_manager_agency_serialize(
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def remove_manager_agency_with_http_info(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def remove_manager_agency_without_preload_content(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _remove_manager_agency_serialize(
        self,
        wink_version,
        accept,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/manager/agency',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def show_manager_invite_list(
        ...
        _param = self._show_manager_invite_list_serialize(
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def show_manager_invite_list_with_http_info(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ManagerInviteAffiliate]]:
        """Show Invites
    ...
    @validate_call
    def show_manager_invite_list_without_preload_content(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _show_manager_invite_list_serialize(
        self,
        wink_version,
        accept,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/manager/invite/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
