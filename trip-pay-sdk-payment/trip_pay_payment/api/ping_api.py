...
class PingApi:
    ...
    def ping_error(
        ...
        _param = self._ping_error_serialize(
            accept=accept,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def ping_error_without_preload_content(
        self,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
