...
class MappingApi:
    ...
    def load_mapping(
        ...
        _param = self._load_mapping_serialize(
            id=id,
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
    ...
    @validate_call
    def load_mapping_with_http_info(
        self,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def load_mapping_without_preload_content(
        self,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def load_mapping_by_external_identifier(
        self,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        ...
        _param = self._load_mapping_by_external_identifier_serialize(
            id=id,
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
    ...
    @validate_call
    def load_mapping_by_external_identifier_with_http_info(
        self,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def load_mapping_by_external_identifier_without_preload_content(
        self,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _load_mapping_by_external_identifier_serialize(
        self,
        id,
        wink_version,
        accept,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/mapping/external/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def load_mappings(
        ...
        _param = self._load_mappings_serialize(
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def load_mappings_with_http_info(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def load_mappings_without_preload_content(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _load_mappings_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/mapping/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def remove_mapping(
        ...
        _param = self._remove_mapping_serialize(
            id=id,
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
    ...
    @validate_call
    def remove_mapping_with_http_info(
        self,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def remove_mapping_without_preload_content(
        self,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def remove_mapping_by_external_identifier(
        self,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        ...
        _param = self._remove_mapping_by_external_identifier_serialize(
            id=id,
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
    ...
    @validate_call
    def remove_mapping_by_external_identifier_with_http_info(
        self,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def remove_mapping_by_external_identifier_without_preload_content(
        self,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _remove_mapping_by_external_identifier_serialize(
        self,
        id,
        wink_version,
        accept,
    ...
    def update_mapping(
        self,
        id: StrictStr,
        update_mapping_request: UpdateMappingRequest,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param id: (required)
        :type id: str
        :param update_mapping_request: (required)
        :type update_mapping_request: UpdateMappingRequest
        :param wink_version:
        :type wink_version: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._update_mapping_serialize(
            id=id,
            update_mapping_request=update_mapping_request,
            wink_version=wink_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def update_mapping_with_http_info(
        self,
        id: StrictStr,
        update_mapping_request: UpdateMappingRequest,
        wink_version: Optional[StrictStr] = None,
    ...
    @validate_call
    def update_mapping_without_preload_content(
        self,
        id: StrictStr,
        update_mapping_request: UpdateMappingRequest,
        wink_version: Optional[StrictStr] = None,
    ...
    def _update_mapping_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_mapping_request is not None:
            _body_params = update_mapping_request
    ...
    @validate_call
    def update_mapping_by_external_identifier(
        self,
        id: StrictStr,
        update_mapping_request: UpdateMappingRequest,
        wink_version: Optional[StrictStr] = None,
        ...
        _param = self._update_mapping_by_external_identifier_serialize(
            id=id,
            update_mapping_request=update_mapping_request,
            wink_version=wink_version,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_mapping_by_external_identifier_with_http_info(
        self,
        id: StrictStr,
        update_mapping_request: UpdateMappingRequest,
        wink_version: Optional[StrictStr] = None,
    ...
    @validate_call
    def update_mapping_by_external_identifier_without_preload_content(
        self,
        id: StrictStr,
        update_mapping_request: UpdateMappingRequest,
        wink_version: Optional[StrictStr] = None,
    ...
    def _update_mapping_by_external_identifier_serialize(
        self,
        id,
        update_mapping_request,
        wink_version,
