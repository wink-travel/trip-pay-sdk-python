...
class ApplicationApi:
    ...
    def create_application(
        self,
        upsert_application_request: UpsertApplicationRequest,
        ...
        :param upsert_application_request: (required)
        :type upsert_application_request: UpsertApplicationRequest
        :param wink_version:
        ...
        _param = self._create_application_serialize(
            upsert_application_request=upsert_application_request,
    ...
    def _create_application_serialize(
        ...
        if upsert_application_request is not None:
            _body_params = upsert_application_request
    ...
    def _delete_application_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/application/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def load_application(
        ...
        _param = self._load_application_serialize(
            id=id,
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
    ...
    @validate_call
    def load_application_with_http_info(
        self,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def load_application_without_preload_content(
        self,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _load_application_serialize(
        self,
        id,
        wink_version,
        accept,
    ...
    def revoke_application(
        ...
        _param = self._revoke_application_serialize(
            id=id,
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
    ...
    @validate_call
    def revoke_application_with_http_info(
        self,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RevokeClientIdResponse]:
        """Revoke Application Credentials
    ...
    @validate_call
    def revoke_application_without_preload_content(
        self,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _revoke_application_serialize(
        self,
        id,
        wink_version,
        accept,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/application/{id}/revoke',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def show_applications_by_user(
        ...
        _param = self._show_applications_by_user_serialize(
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def show_applications_by_user_with_http_info(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def show_applications_by_user_without_preload_content(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _show_applications_by_user_serialize(
        self,
        wink_version,
        accept,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/application/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
