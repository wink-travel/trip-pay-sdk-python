...
class PayoutApi:
    ...
    def create_ephemeral_key(
        self,
        create_issuing_card_ephemeral_key_request: CreateIssuingCardEphemeralKeyRequest,
        ...
        :param create_issuing_card_ephemeral_key_request: (required)
        :type create_issuing_card_ephemeral_key_request: CreateIssuingCardEphemeralKeyRequest
        :param wink_version:
        ...
        _param = self._create_ephemeral_key_serialize(
            create_issuing_card_ephemeral_key_request=create_issuing_card_ephemeral_key_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "CreateIssuingCardEphemeralKeyResponse",
        }
    ...
    @validate_call
    def create_ephemeral_key_with_http_info(
        self,
        create_issuing_card_ephemeral_key_request: CreateIssuingCardEphemeralKeyRequest,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateIssuingCardEphemeralKeyResponse]:
        """Create Stripe ephemeral key
    ...
    @validate_call
    def create_ephemeral_key_without_preload_content(
        self,
        create_issuing_card_ephemeral_key_request: CreateIssuingCardEphemeralKeyRequest,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _create_ephemeral_key_serialize(
        self,
        create_issuing_card_ephemeral_key_request,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        if create_issuing_card_ephemeral_key_request is not None:
            _body_params = create_issuing_card_ephemeral_key_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/issuing-card/ephemeral',
