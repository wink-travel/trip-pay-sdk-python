...
class WebhookApi:
    ...
    def create_webhook(
        self,
        upsert_webhook_request: UpsertWebhookRequest,
        ...
        :param upsert_webhook_request: (required)
        :type upsert_webhook_request: UpsertWebhookRequest
        :param wink_version:
        ...
        _param = self._create_webhook_serialize(
            upsert_webhook_request=upsert_webhook_request,
    ...
    def _create_webhook_serialize(
        ...
        if upsert_webhook_request is not None:
            _body_params = upsert_webhook_request
    ...
    def load_webhook(
        ...
        _param = self._load_webhook_serialize(
            id=id,
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
    ...
    @validate_call
    def load_webhook_with_http_info(
        self,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def load_webhook_without_preload_content(
        self,
        id: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def show_webhook_events(
        ...
        _param = self._show_webhook_events_serialize(
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def show_webhook_events_with_http_info(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def show_webhook_events_without_preload_content(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _show_webhook_events_serialize(
        self,
        wink_version,
        accept,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/webhook/event/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def show_webhooks_by_accounts_by_owner(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _param = self._show_webhooks_by_accounts_by_owner_serialize(
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def show_webhooks_by_accounts_by_owner_with_http_info(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def show_webhooks_by_accounts_by_owner_without_preload_content(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _show_webhooks_by_accounts_by_owner_serialize(
        self,
        wink_version,
        accept,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/webhook/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
