...
from trip_pay_payment.api_response import ApiResponse, T as ApiResponseT
import trip_pay_payment.models
from trip_pay_payment import rest
from trip_pay_payment.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(trip_pay_payment.models, klass)
