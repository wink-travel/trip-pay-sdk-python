...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.trippay.io" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("trip_pay_payment")
    ...
    def to_debug_report(self) -> str:
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 30.32.0\n"\
               "SDK Package Version: 0.0.53".\
