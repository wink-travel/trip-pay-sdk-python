...
```sh
pip install git+https://github.com/wink-travel/trip-pay-sdk-python.git@v0.0.53#egg=trip_pay_payment&subdirectory=trip-pay-sdk-payment
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/trip-pay-sdk-python.git@v0.0.53#egg=trip_pay_payment&subdirectory=trip_pay_payment`)
...
*AccountMappingsApi* | [**find_account_mapping**](docs/AccountMappingsApi.md#find_account_mapping) | **GET** /api/account/{accountIdentifier}/mapping/{id} | Show Account Mapping
...
*AccountMappingsApi* | [**show_account_mapping_grid**](docs/AccountMappingsApi.md#show_account_mapping_grid) | **POST** /api/account/{accountIdentifier}/mapping/grid | Show Account Mappings
...
*ManagingEntityApi* | [**change_name**](docs/ManagingEntityApi.md#change_name) | **PATCH** /api/my-account/change-name | Change Name
*ManagingEntityApi* | [**is_managing_entity_name_unique**](docs/ManagingEntityApi.md#is_managing_entity_name_unique) | **POST** /api/managing-entity-name-check | Verify Managing Entity Name
*ManagingEntityApi* | [**is_name_unique**](docs/ManagingEntityApi.md#is_name_unique) | **GET** /api/managing-entity/name | Name Check
*ManagingEntityApi* | [**is_url_name_unique**](docs/ManagingEntityApi.md#is_url_name_unique) | **POST** /api/managing-entity-url-name-check | Verify Managing Entity Url Name
*ManagingEntityApi* | [**remove_managing_entity**](docs/ManagingEntityApi.md#remove_managing_entity) | **DELETE** /api/managing-entity/{managingEntityIdentifier} | Delete Managing Entity
*ManagingEntityApi* | [**remove_my_account**](docs/ManagingEntityApi.md#remove_my_account) | **DELETE** /api/my-account | Delete My Account
*ManagingEntityApi* | [**show_accessible_managing_entities**](docs/ManagingEntityApi.md#show_accessible_managing_entities) | **GET** /api/managing-entity/list | List Managing Entities
*ManagingEntityApi* | [**show_accessible_managing_entities_by_state**](docs/ManagingEntityApi.md#show_accessible_managing_entities_by_state) | **POST** /api/managing-entity/grid | Search Managing Entities
*ManagingEntityApi* | [**show_managing_entities**](docs/ManagingEntityApi.md#show_managing_entities) | **GET** /api/managing-entity/list/all | Show All Managing Entities
*ManagingEntityApi* | [**show_managing_entity**](docs/ManagingEntityApi.md#show_managing_entity) | **GET** /api/managing-entity/{managingEntityIdentifier} | Show Managing Entity
*ManagingEntityApi* | [**show_my_account**](docs/ManagingEntityApi.md#show_my_account) | **GET** /api/my-account | Show My Account
*ManagingEntityApi* | [**show_sales_channels**](docs/ManagingEntityApi.md#show_sales_channels) | **GET** /api/sales-channel/search | Search Sales Channel by Name
*ManagingEntityApi* | [**update_managing_entity_account_representative**](docs/ManagingEntityApi.md#update_managing_entity_account_representative) | **PATCH** /api/my-account/account-representative | Update Account Representative
*ManagingEntityApi* | [**update_my_account_address**](docs/ManagingEntityApi.md#update_my_account_address) | **PATCH** /api/my-account/address | Update Address
*ManagingEntityApi* | [**update_my_account_logo**](docs/ManagingEntityApi.md#update_my_account_logo) | **PATCH** /api/my-account/logo | Update Logo
*ManagingEntityApi* | [**update_profile**](docs/ManagingEntityApi.md#update_profile) | **PATCH** /api/managing-entity/{managingEntityIdentifier}/profile | Update Profile
*ManagingEntityApi* | [**update_profile_picture**](docs/ManagingEntityApi.md#update_profile_picture) | **PATCH** /api/my-account/profile-picture | Update Profile Picture
...
*NotificationApi* | [**remove_notification**](docs/NotificationApi.md#remove_notification) | **DELETE** /api/message/{messageIdentifier} | Delete Notification
*NotificationApi* | [**remove_notification1**](docs/NotificationApi.md#remove_notification1) | **DELETE** /api/managing-entity/{managingEntityIdentifier}/message/{messageIdentifier} | Delete Notification
*NotificationApi* | [**show_all_notifications**](docs/NotificationApi.md#show_all_notifications) | **GET** /api/message/list | Show Notifications
*NotificationApi* | [**show_notification**](docs/NotificationApi.md#show_notification) | **GET** /api/message/{messageIdentifier} | Show Notification
*NotificationApi* | [**show_notification1**](docs/NotificationApi.md#show_notification1) | **GET** /api/managing-entity/{managingEntityIdentifier}/message/{messageIdentifier} | Show Notification
*NotificationApi* | [**show_notifications**](docs/NotificationApi.md#show_notifications) | **GET** /api/managing-entity/{managingEntityIdentifier}/message/list | Show Notifications
*NotificationApi* | [**show_unread_message_count**](docs/NotificationApi.md#show_unread_message_count) | **GET** /api/message/count | Show Unread Count
*NotificationApi* | [**show_unread_message_count1**](docs/NotificationApi.md#show_unread_message_count1) | **GET** /api/managing-entity/{managingEntityIdentifier}/message/count | Show Unread Count
...
## Documentation For Models
 ...
 - [AggregateDescriptorPayment](docs/AggregateDescriptorPayment.md)
 ...
 - [ChangeManagingEntityNameRequestAuthenticatedEntity](docs/ChangeManagingEntityNameRequestAuthenticatedEntity.md)
 - [CompositeFilterDescriptorPayment](docs/CompositeFilterDescriptorPayment.md)
 - [Contact](docs/Contact.md)
 - [CountResponse](docs/CountResponse.md)
 - [CountResponseAuthenticatedEntity](docs/CountResponseAuthenticatedEntity.md)
 ...
 - [Fee](docs/Fee.md)
 - [FilterDescriptorPayment](docs/FilterDescriptorPayment.md)
 - [GeoJsonPoint](docs/GeoJsonPoint.md)
 - [GeoNameLightweight](docs/GeoNameLightweight.md)
 - [GeoNameLightweightPayment](docs/GeoNameLightweightPayment.md)
 - [GroupDescriptorPayment](docs/GroupDescriptorPayment.md)
 ...
 - [ManagedByEntity](docs/ManagedByEntity.md)
 - [ManagedByEntityRules](docs/ManagedByEntityRules.md)
 ...
 - [ManagingEntityAuthenticatedEntity](docs/ManagingEntityAuthenticatedEntity.md)
 - [ManagingEntityManager](docs/ManagingEntityManager.md)
 - [ManagingEntityManagerPayment](docs/ManagingEntityManagerPayment.md)
 - [ManagingEntityPayment](docs/ManagingEntityPayment.md)
 - [ManagingEntityProvisionPayment](docs/ManagingEntityProvisionPayment.md)
 ...
 - [NotificationAuthenticatedEntity](docs/NotificationAuthenticatedEntity.md)
 - [PageAccount](docs/PageAccount.md)
 - [PageBookingContract](docs/PageBookingContract.md)
 - [PageManagingEntityPayment](docs/PageManagingEntityPayment.md)
 - [PageMapping](docs/PageMapping.md)
 - [PageableObjectPayment](docs/PageableObjectPayment.md)
 ...
 - [PetInfoLightweight](docs/PetInfoLightweight.md)
 ...
 - [SimpleMultimediaPayment](docs/SimpleMultimediaPayment.md)
 - [SortDescriptorPayment](docs/SortDescriptorPayment.md)
 - [SortObjectPayment](docs/SortObjectPayment.md)
 - [State](docs/State.md)
 - [StatePayment](docs/StatePayment.md)
 ...
 - [UniqueRequestAuthenticatedEntity](docs/UniqueRequestAuthenticatedEntity.md)
 - [UniqueResult](docs/UniqueResult.md)
 - [UniqueResultAuthenticatedEntity](docs/UniqueResultAuthenticatedEntity.md)
 - [UniqueResultPayment](docs/UniqueResultPayment.md)
 - [UpdateAccountRepresentativeRequestAuthenticatedEntity](docs/UpdateAccountRepresentativeRequestAuthenticatedEntity.md)
 ...
 - [UpdateManagingEntityInformationRequestAuthenticatedEntity](docs/UpdateManagingEntityInformationRequestAuthenticatedEntity.md)
 ...
 - [UpsertImageRequestAuthenticatedEntity](docs/UpsertImageRequestAuthenticatedEntity.md)
 - [UpsertWebhookManagingEntityRequest](docs/UpsertWebhookManagingEntityRequest.md)
