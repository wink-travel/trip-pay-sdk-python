...
```sh
pip install git+https://github.com/wink-travel/trip-pay-sdk-python.git@v0.0.11#egg=trip_pay_payment&subdirectory=trip-pay-sdk-payment
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/trip-pay-sdk-python.git@v0.0.11#egg=trip_pay_payment&subdirectory=trip_pay_payment`)
...
*AccountApi* | [**load_account_grid_for_authenticated_user**](docs/AccountApi.md#load_account_grid_for_authenticated_user) | **POST** /api/account/grid | Show Account Grid for UserLightweight
*AccountApi* | [**load_accounts_for_authenticated_user**](docs/AccountApi.md#load_accounts_for_authenticated_user) | **GET** /api/account/list | Show Account for UserLightweight
...
*ApplicationApi* | [**show_managing_entities**](docs/ApplicationApi.md#show_managing_entities) | **GET** /api/managing-entity/{managingEntityIdentifier} | Show Managing Entity
*ApplicationApi* | [**show_managing_entities1**](docs/ApplicationApi.md#show_managing_entities1) | **GET** /api/managing-entity/list | Show Managing Entities
...
*NotificationLightweightApi* | [**remove_notification**](docs/NotificationLightweightApi.md#remove_notification) | **DELETE** /api/account/{accountIdentifier}/message/{messageIdentifier} | Delete NotificationLightweight
*NotificationLightweightApi* | [**show_notification**](docs/NotificationLightweightApi.md#show_notification) | **GET** /api/account/{accountIdentifier}/message/{messageIdentifier} | Show NotificationLightweight
*NotificationLightweightApi* | [**show_notifications**](docs/NotificationLightweightApi.md#show_notifications) | **GET** /api/account/{accountIdentifier}/message/list | Show Notifications
*NotificationLightweightApi* | [**show_unread_message_count**](docs/NotificationLightweightApi.md#show_unread_message_count) | **GET** /api/account/{accountIdentifier}/message/count | Show Unread Count
...
*SendNotificationControllerApi* | [**create_notification**](docs/SendNotificationControllerApi.md#create_notification) | **POST** /api/administration/notification | 
